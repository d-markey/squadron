...
compile "wasm" ""    "./test/workers/js/cache_worker.dart"         "./test/workers/wasm/cache_worker.dart.wasm"
compile "wasm" ""    "./test/workers/wasm/echo_worker.dart"        "./test/workers/wasm/echo_worker.dart.wasm"
compile "wasm" ""    "./test/workers/js/installable_worker.dart"   "./test/workers/wasm/installable_worker.dart.wasm"
compile "wasm" ""    "./test/workers/js/issues_worker.dart"        "./test/workers/wasm/issues_worker.dart.wasm"
compile "wasm" ""    "./test/workers/js/local_client_worker.dart"  "./test/workers/wasm/local_client_worker.dart.wasm"
compile "wasm" ""    "./test/workers/js/prime_worker.dart"         "./test/workers/wasm/prime_worker.dart.wasm"
