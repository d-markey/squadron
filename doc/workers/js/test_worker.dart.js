...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    TestService_operations_closure21: function TestService_operations_closure21(t0) {
      this.$this = t0;
    },
    main() {
      A.bootstrap(new A.main_closure(), null);
    },
  ...
  A.TestService.prototype = {
    ...
    get$operations() {
      ...
      if (value === $) {
        ...
        t1.$indexSet(0, 61, new A.TestService_operations_closure21(_this));
  ...
  A.TestService_operations_closure21.prototype = {
    call$1(r) {
      type$.List_dynamic._as(r);
      return $.$get$Squadron_platformType().label;
    },
    $signature: 49
  };
