...
(function dartProgram() {
  ...
  A._WebWorkerChannel.prototype = {
    _postResponse$1(res) {
      var ex, st, exception;
      try {
        this._sendPort.postMessage(A.jsify(A.WorkerResponseExt_wrapInPlace(res)));
      } catch (exception) {
        ex = A.unwrapException(exception);
        st = A.getTraceFromException(exception);
    ...
    _inspectAndPostResponse$1(res) {
      var data, transfer, ex, st, t1, objects, t2, exception;
      try {
  ...
  A.SquadronCanceledException.prototype = {
    serialize$0() {
      ...
      return A.List_List$unmodifiable(["$cncld", this.tokenId, t1, t2], type$.dynamic);
    },
  ...
  A.TestService.prototype = {
    ...
    io$1$ms(ms) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue;
      var $async$io$1$ms = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait(A.Future_Future$delayed(A.Duration$(0, ms), type$.void), $async$io$1$ms);
            case 3:
              // returning from await.
      ...
      return A._asyncStartSync($async$io$1$ms, $async$completer);
    },
    cpu$1$ms(ms) {
      var t1,
        sw = new A.Stopwatch();
  ...
  A.TestService_operations_closure3.prototype = {
    call$1(r) {
      var t1 = type$.List_dynamic;
      return this.$this.io$1$ms(B.JSNumber_methods.toInt$0(A._asNum(J.$index$ax(t1._as(J.$index$ax(t1._as(r), 3)), 0))));
    },
    $signature: 14
  };
