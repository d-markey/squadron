...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    WorkerResponse_constructor_log(message) {
      return A.WorkerResponse_constructor__([A.Timestamp_constructor_now(), null, null, null, A._LogEventSerializationExt_serialize(message)]);
    },
