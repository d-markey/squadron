...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    $jsify(message, transfer) {
      var t1 = type$.Object,
        cache = A.HashMap_HashMap(A._patch___$equals$closure(), t1, t1);
    ...
    $dartify(message) {
      var t1 = type$.Object;
      return new A.$dartify_squadronDartify(A.HashMap_HashMap(A._patch___$equals$closure(), t1, t1)).call$1(message);
    },
  ...
  (function installTearOffs() {
    ...
    _static_2(A, "_patch___$equals$closure", "_$equals", 41);
    var _;
    ...
    _static_1(A, "num_converter_NumConverter__toInt$closure", "NumConverter__toInt", 43);
    _static_1(A, "num_converter_NumConverter__toDbl$closure", "NumConverter__toDbl", 44);
    _static_1(A, "squadron_canceled_exception__SquadronCanceledExceptionExt_deserialize$closure", "SquadronCanceledExceptionExt_deserialize", 29);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(List<@>)", "~(@)", "Null()", "Object?(Object?)", "String()", "~(~())", "~(Object?,Object?)", "Null(List<@>)", "Null(@)", "Null(Object)", "@(@)", "_Future<@>(@)", "bool(@)", "Null(Object,StackTrace)", "~(Object,StackTrace)", "int(int)", "Null(~())", "~(WorkerRunner)", "Null(JSObject)", "~(int,@)", "~(LogEvent)", "Null(@,StackTrace)", "~(JSObject)", "~(OutputEvent)", "bool(int)", "CancelationTokenReference()", "SquadronCanceledException(CanceledException)", "String(SquadronCanceledException)", "SquadronCanceledException?(List<@>?)", "~([@])", "Future<String>(List<@>)", "@(String)", "@(@,String)", "@(List<@>)", "bool/(List<@>)", "bool(Level)", "ErrorService(List<@>)", "List<@>(SquadronCanceledException)", "~(Zone?,ZoneDelegate?,Zone,~())", "int(Object?)", "bool(Object,Object)", "0^(@)<Object?>", "int(@)", "double(@)", "int(int,int)"],
