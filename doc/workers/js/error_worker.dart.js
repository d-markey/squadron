// Generated by dart2js (, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.13.4.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    print(object) {
      var line = A.S(object),
        toZone = A.printToZone();
      if (toZone == null)
        A.printToConsole(line);
      else
        toZone.call$1(line);
    },
    ...
    _isJSAny(any) {
      return type$.Interceptor._is(any);
    },
    _isJSTypedArray(any) {
      var typedArrayProto,
        t1 = A._getPropertyTrustType(A.staticInteropGlobalContext(), "Object", type$.Object),
        t2 = A.JSObjectUnsafeUtilExtension___(A.globalContext(), "Int8Array");
      t2.toString;
      typedArrayProto = A._callMethodUnchecked1(t1, "getPrototypeOf", t2, type$.JavaScriptFunction);
      if (A._isJSAny(any))
        t1 = A.JSAnyUtilityExtension_instanceof(any == null ? A._asObject(any) : any, typedArrayProto);
      else
        t1 = false;
      return t1;
    },
    ...
    JSBooleanToBool_get_toDart(_this) {
      return A.JSBooleanTypeExtension_get_self(_this);
    },
    ...
    JSAnyOperatorExtension_get_isTruthy(_this) {
      return A.JSBoolean_constructor__(A.JSBooleanType_constructor_(A.isTruthy(_this, type$.dynamic)));
    },
    ...
    LogEvent$(level, message, error, stackTrace, time) {
      return new A.LogEvent(level, message, error, stackTrace, time == null ? A.clock().now$0() : time);
    },
    ...
    bootstrap(initializer, command) {
      ...
      resp = A.WorkerResponse_constructor_ready();
      A.WorkerResponse_wrapInPlace(resp);
      message = A.$jsify(resp, transfer);
    ...
    _getJSValue(dart) {
      if (typeof dart == "number")
        return A.NumToJSExtension_get_toJS(dart);
      if (typeof dart == "string")
        return A.StringToJSString_get_toJS(dart);
      if (A._isBool(dart))
        return A.BoolToJSBoolean_get_toJS(dart);
      if (dart instanceof A._BigIntImpl)
        return A._toJSBigInt(dart);
      if (dart instanceof A.DateTime)
        return A._toJSDate(dart);
      return null;
    },
    $jsify(message, transfer) {
      ...
      return type$.JSArray_nullable_Object._as(squadronJsify.readLocal$1$0(type$.nullable_Object_Function_nullable_Object).call$1(message));
    },
    _getDartValue(js) {
      var t1 = A.JSAnyUtilityExtension_typeofEquals(js, "number");
      if (t1)
        return A.JSAnyUtilityExtension_dartify(A._asDouble(js));
      t1 = A.JSAnyUtilityExtension_typeofEquals(js, "string");
      if (t1)
        return A.JSStringToString_get_toDart(A._asString(js));
      t1 = A.JSAnyUtilityExtension_typeofEquals(js, "boolean");
      if (t1)
        return A.JSBooleanToBool_get_toDart(A._asBool(js));
      t1 = A.JSAnyUtilityExtension_typeofEquals(js, "bigint");
      if (t1)
    ...
    $dartify(message) {
      ...
      if (A.NullableUndefineableJSAnyExtension_get_isUndefinedOrNull(message))
        return null;
      if (message == null)
        A._asObject(message);
    ...
    $JSEventExt__getMessageEventData(obj) {
      return A.$dartify(obj == null ? null : A.JSObjectUnsafeUtilExtension_getProperty(obj, $.$get$_$kData(), type$.nullable_Object));
    },
    ...
    $JSIteratorExt_$next(_this) {
      return A.JSObjectUnsafeUtilExtension_callMethod(_this, $.$get$_$kNext(), type$.nullable_JSObject);
    },
    $JSIteratorResultExt_get_$done(_this) {
      return A.JSBooleanToBool_get_toDart(A.JSAnyOperatorExtension_get_isTruthy(A.JSObjectUnsafeUtilExtension_getProperty(_this, $.$get$_$kDone(), type$.nullable_Object)));
    },
    $JSIteratorResultExt_get_$value(_this) {
      return A.JSObjectUnsafeUtilExtension_getProperty(_this, $.$get$_$kValue(), type$.nullable_Object);
    },
    ...
    JsWorkerRunnerExt_handle(_this, $event) {
      ...
      t1.toString;
      return _this.processRequest$1(A.WorkerRequest_constructor_from(t1));
    },
    JsWorkerRunnerExt_get_handle_closure: function JsWorkerRunnerExt_get_handle_closure(t0) {
      this._this = t0;
    },
    WorkerRunner$(_terminate) {
      return new A.WorkerRunner(_terminate, A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.CancelationTokenReference), A.LinkedHashMap_LinkedHashMap$_empty(type$.int, type$.void_Function));
    },
    WorkerRunner__checkOperations(ops) {
      var t2,
        invalidKeys = J.toList$0$ax(J.where$1$ax(A.OperationsMap_get_keys(ops), new A.WorkerRunner__checkOperations_closure())),
    ...
    WorkerRunner: function WorkerRunner(t0, t1, t2) {
      ...
      _._executing = 0;
      _._streamCancelers = t2;
      _._installError = _._installCompleter = null;
    },
    ...
    TestLogger$(filter) {
      ...
      t3.Logger$4$filter$level$output$printer(filter, B.Level_0_0_all, t1, t2);
      return t3;
    },
    NoOutput$() {
    ...
    JSBooleanTypeExtension_get_self(_this) {
      return _this;
    },
    ...
    clock() {
      var t1 = type$.nullable_Clock._as(J.$index$ax(A.Zone_current(), $.$get$_clockKey()));
      return t1 == null ? B.C_Clock : t1;
    },
    isSameInstance(a, b) {
      var t1;
      A._asObject(a);
    ...
    WorkerMessage_unwrapTravelTime(_this) {
      ...
      if (ts != null) {
        t1 = A.Timestamp_constructor_now();
        t1.toString;
        J.$indexSet$ax(_this, 0, A.Timestamp__(t1, ts));
      }
    },
  ...
  A.DateTime.prototype = {
    ...
    get$microsecondsSinceEpoch() {
      return 1000 * this._core$_value + this._microsecond;
    },
    get$year() {
  ...
  A.Duration.prototype = {
    get$inMilliseconds() {
      return B.JSInt_methods._tdivFast$1(this.inMicroseconds, 1000);
    },
    $eq(_, other) {
      if (other == null)
        return false;
  ...
  A.LogFilter.prototype = {
    get$level() {
      var t1 = this._level;
      return t1 == null ? B.Level_1000_2_trace : t1;
    },
    set$level(value) {
  ...
  A.Logger.prototype = {
    ...
    t$1(message) {
      this.log$5$error$stackTrace$time(B.Level_1000_2_trace, message, null, null, null);
    },
    d$1(message) {
      this.log$5$error$stackTrace$time(B.Level_2000_3_debug, message, null, null, null);
    },
    i$1(message) {
      this.log$5$error$stackTrace$time(B.Level_3000_4_info, message, null, null, null);
    },
    w$1(message) {
      this.log$5$error$stackTrace$time(B.Level_4000_5_warning, message, null, null, null);
    },
    e$1(message) {
      this.log$5$error$stackTrace$time(B.Level_5000_6_error, message, null, null, null);
    },
    f$1(message) {
      this.log$5$error$stackTrace$time(B.Level_6000_8_fatal, message, null, null, null);
    },
  ...
  A.bootstrap_closure0.prototype = {
    call$1(e) {
      ...
      t4.toString;
      t3.connect$3(A.WorkerRequest_constructor_from(t4), A.getProperty(t1, "port2", t2), this.initializer);
    },
    $signature: 21
  };
  ...
  A.$dartify_closure.prototype = {
    call$1(js) {
      var dart, t1, t2, cached, t3, len, dartList, i, keys, dartMap, t4, res, entry, values, dartSet, _this = this;
      if (A.NullableUndefineableJSAnyExtension_get_isUndefinedOrNull(js))
        return null;
      if (js == null)
        A._asObject(js);
      ...
      if (t3) {
        ...
        for (t1 = type$.JSArray_nullable_Object, t2 = _this.squadronDartify, t3 = type$.nullable_Object_Function_nullable_Object, t4 = type$.nullable_Object;;) {
      ...
      if (t3) {
        ...
        for (t1 = _this.squadronDartify, t2 = type$.nullable_Object_Function_nullable_Object;;) {
  ...
  A._WebWorkerChannel.prototype = {
    _postResponse$1(res) {
      ...
      try {
        ...
        A._callMethodUnchecked1(this._sendPort, "postMessage", A.$jsify(res, null), type$.void);
      } catch (exception) {
    ...
    _inspectAndPostResponse$1(res) {
      var transfer, message, ex, st, exception, t1;
      type$.List_dynamic._as(res);
      try {
        A.WorkerResponse_wrapInPlace(res);
    ...
    reply$1(data) {
      return this._postResponse$1(A.WorkerResponse_constructor_withResult(data));
    },
    inspectAndReply$1(data) {
      return this._inspectAndPostResponse$1(A.WorkerResponse_constructor_withResult(data));
    },
    error$3(err, stackTrace, command) {
      this._postResponse$1(A.WorkerResponse_constructor_withError(A.SquadronException_from(A._asObject(err), type$.nullable_StackTrace._as(stackTrace), A._asIntQ(command))));
    },
  ...
  A.WorkerRunner.prototype = {
    ...
    connect$body$WorkerRunner(startRequest, channelInfo, initializer) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$errorStack = [], $async$self = this, service, ex, st, t1, t2, exception, channel, $async$exception;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              if (!t1)
                A.WorkerRequest_unwrapInPlace(startRequest, null);
              t2 = t1 ? null : A.WorkerRequest_get_channel(startRequest);
              channel.set$finalLocalValue(t2);
              if (t1) {
                t1 = A.SquadronErrorImpl_create("Missing connection request", null);
                throw A.wrapException(t1);
              } else if (channel.readLocal$1$0(type$.nullable_WorkerChannel) == null) {
            ...
            case 7:
              ...
              A.WorkerRunner__checkOperations(service.get$operations());
              $async$self._service = service;
              $async$self._operations = service.get$operations();
              channel.readLocal$1$0(type$.WorkerChannel).connect$1(channelInfo);
              $async$handler = 1;
              // goto after finally
              $async$goto = 5;
              break;
            case 3:
              ...
              t1 = channel.readLocal$1$0(type$.nullable_WorkerChannel);
              if (t1 != null)
                t1.error$2(ex, st);
              $async$self._exit$0();
              // goto after finally
    ...
    processRequest$body$WorkerRunner(request) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$next = [], $async$self = this, pendingInstallation, token, canceler, cmd, op, token0, tokenRef, result, reply, ex, st, t1, exception, channel, $async$exception;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              channel = null;
              $async$handler = 4;
              A.WorkerRequest_unwrapInPlace(request, null);
  ...
  A.SquadronTimeoutException.prototype = {
    serialize$0() {
      ...
      t1 = t1 == null ? null : t1.toString$0(0);
      t2 = _this.duration;
      t2 = t2 == null ? null : t2.inMicroseconds;
  ...
  A.ErrorService.prototype = {
    setLevel$1(level) {
      this._error_service$_logger.set$level(J.get$first$ax(B.JSArray_methods.where$1(B.List_jnT, new A.ErrorService_setLevel_closure(A._asInt(level)))));
    },
    log$0() {
  ...
  (function inheritance() {
    ...
    _inherit(A.ProductionFilter, A.LogFilter);
    ...
    _inherit(A.NoOutput, A.LogOutput);
    _inherit(A.EmptyPrinter, A.LogPrinter);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      WorkerChannel: findType("WorkerChannel"),
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "_clockKey", "$get$_clockKey", () => A.Object$());
    ...
    _lazyFinal($, "_$kData", "$get$_$kData", () => A.StringToJSString_get_toJS("data"));
    _lazyFinal($, "_$kNext", "$get$_$kNext", () => A.StringToJSString_get_toJS("next"));
    _lazyFinal($, "_$kDone", "$get$_$kDone", () => A.StringToJSString_get_toJS("done"));
    _lazyFinal($, "_$kValue", "$get$_$kValue", () => A.StringToJSString_get_toJS("value"));
