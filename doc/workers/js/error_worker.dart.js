...
(function dartProgram() {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 6:
              ...
              if (A.boolConversionCheck(J.get$isNotEmpty$asx(J.where$1$ax(A.OperationsMap_get_keys($async$self._service.get$operations()), new A.WorkerRunner_connect_closure0())))) {
                t2 = A.SquadronErrorImpl_create("Invalid command identifier in service operations map; command ids must be > 0", null);
                throw A.wrapException(t2);
              }
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 8:
              ...
              op = t1 == null ? null : A.OperationsMap___(t1.get$operations(), cmd);
              if (op == null) {
  ...
  A.NumConverter.prototype = {
    value$1$0($T) {
      A.checkTypeBound($T, type$.Object, "T", "value");
      if (A.boolConversionCheck(J.$eq$(A.createRuntimeType($T), B.Type_int_8nG)))
        return $T._eval$1("0(@)")._as(A.num_converter_NumConverter__toInt$closure());
      if (A.boolConversionCheck(J.$eq$(A.createRuntimeType($T), B.Type_double_23F)))
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 39, 0);
    _static_1(A, "collection___defaultHashCode$closure", "_defaultHashCode", 40);
    ...
    _static_1(A, "num_converter_NumConverter__toInt$closure", "NumConverter__toInt", 42);
    _static_1(A, "num_converter_NumConverter__toDbl$closure", "NumConverter__toDbl", 43);
    _static_1(A, "squadron_canceled_exception__SquadronCanceledExceptionExt_deserialize$closure", "SquadronCanceledExceptionExt_deserialize", 44);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(List<@>)", "~(@)", "Null()", "Object?(Object?)", "String()", "~(~())", "~(Object?,Object?)", "Null(List<@>)", "Null(@)", "Null(Object)", "@(@)", "_Future<@>(@)", "bool(@)", "Null(Object,StackTrace)", "~(Object,StackTrace)", "int(int)", "Null(~())", "~(WorkerRunner)", "Null(JSObject)", "~(int,@)", "~(LogEvent)", "Null(@,StackTrace)", "~(JSObject)", "~(OutputEvent)", "bool(int)", "CancelationTokenReference()", "SquadronCanceledException(CanceledException)", "String(SquadronCanceledException)", "bool(Object,Object)", "~([@])", "bool(Level)", "Future<String>(List<@>)", "@(String)", "@(@,String)", "@(List<@>)", "bool/(List<@>)", "ErrorService(List<@>)", "List<@>(SquadronCanceledException)", "~(Zone?,ZoneDelegate?,Zone,~())", "int(Object?)", "0^(@)<Object?>", "int(@)", "double(@)", "SquadronCanceledException?(List<@>?)", "int(int,int)"],
