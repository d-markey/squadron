// Generated by dart2js (, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.10.0.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    bootstrap(initializer, command) {
      ...
      message = A.$jsify(A.WorkerResponse_wrapInPlace(A.WorkerResponse_constructor_ready()), transfer);
    ...
    getPlatformConverter() {
      return B.SquadronPlatformType_2_js.get$isJs() ? B.C_CastConverter : B.C_NumConverter;
    },
    isSameInstance(a, b) {
      var t1;
      A._asObject(a);
  ...
  A.DateTime$_internal_closure.prototype = {
    call$0() {
      var _this = this;
      return A.throwExpression(A.ArgumentError$("(" + A.S(_this.year) + ", " + A.S(_this.month) + ", " + A.S(_this.day) + ", " + A.S(_this.hour) + ", " + A.S(_this.minute) + ", " + A.S(_this.second) + ", " + A.S(_this.millisecond) + ", " + A.S(_this.microsecond) + ")", null));
    },
    $signature: 16
  };
  ...
  A._WebWorkerChannel.prototype = {
    _postResponse$1(res) {
      ...
      try {
        A._callMethodUnchecked1(this._sendPort, "postMessage", A.$jsify(A.WorkerResponse_wrapInPlace(res), null), type$.void);
      } catch (exception) {
        ex = A.unwrapException(exception);
    ...
    _inspectAndPostResponse$1(res) {
      ...
      type$.List_dynamic._as(res);
      try {
        data = A.WorkerResponse_wrapInPlace(res);
    ...
    log$1(message) {
      return this._postResponse$1(A.WorkerResponse_constructor_log(type$.LogEvent._as(message)));
    },
          ...
          switch ($async$goto) {
            case 0:
              ...
              if ($async$self._logForwarder == null) {
                logger = channel.readLocal$1$0(type$.WorkerChannel).get$log();
                t1 = new A.WorkerRunner_connect_closure(logger);
                $async$self._logForwarder = t1;
                A.Logger_addOutputListener(t1);
              }
  ...
  A.SquadronPlatformType.prototype = {
    ...
    get$isJs() {
      return this === B.SquadronPlatformType_2_js;
    },
    toString$0(_) {
      return "JavaScript";
    }
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "collection___defaultHashCode$closure", "_defaultHashCode", 39);
    ...
    _instance_1_u(_, "get$log", "log$1", 21);
    ...
    _instance(A.SquadronCancelationToken.prototype, "get$_checkToken", 0, 0, null, ["call$1", "call$0"], ["_checkToken$1", "_checkToken$0"], 30, 0, 0);
...
;
    ...
    B.SquadronPlatformType_2_js = new A.SquadronPlatformType(2, "js");
