...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    checkTypeBound(type, bound, variable, methodName) {
      if (A.isSubtype(A._theUniverse(), type, bound))
        return type;
      throw A.initializeExceptionWrapper(A._TypeError$fromMessage("The type argument '" + A.S(A._rtiToString(type, null)) + "' is not a subtype of the type variable bound '" + A.S(A._rtiToString(bound, null)) + "' of type variable '" + variable + "' in '" + methodName + "'."), new Error());
    },
    ...
    _CustomHashMap$(_equals, _hashCode, validKey, $K, $V) {
      ...
      _equals.toString;
      _hashCode.toString;
      t1 = validKey != null ? validKey : new A._CustomHashMap_closure($K);
    ...
    bootstrap(initializer, command) {
      var t1, t2, com, runner, transfer, message;
    ...
    JSAnyUtilityExtension_instanceOfString(_this, constructorName) {
      ...
      for (t1 = B.JSArray_methods.get$iterator(parts), t2 = type$.nullable_JSObject; t1.moveNext$0();) {
        t3 = t1.get$current();
    ...
    isSameInstance(a, b) {
      ...
      t2 = type$.JSObject;
      if (t2._is(a))
        t1 = t2._is(b) && A._callMethodUnchecked2(A._getPropertyTrustType(A.staticInteropGlobalContext(), "Object", t1), "is", a, b, type$.bool);
      else
        t1 = !t2._is(b) && a === b;
      return t1;
    },
    ...
    WorkerRequestExt_from(data) {
      if (!J.$eq$(J.get$length$asx(data), 7))
    ...
    CancelationTokenExt_overrideCancelToken(_this, token) {
      if (A.WorkerRequest_get_cancelToken(_this) == null || !J.$eq$(A.WorkerRequest_get_cancelToken(_this).get$id(), token.get$id()))
  ...
  A.LinkedHashMapKeyIterator.prototype = {
    ...
    moveNext$0() {
      ...
      if (!J.$eq$(_this.__js_helper$_modifications, t1.__js_helper$_modifications))
        throw A.wrapException(A.ConcurrentModificationError$(t1));
  ...
  A._Future.prototype = {
    ...
    _completeError$2(error, stackTrace) {
      this._completeErrorObject$1(A.AsyncError$(type$.Object._as(error), type$.StackTrace._as(stackTrace)));
    },
    ...
    _asyncCompleteError$2(error, stackTrace) {
      this._asyncCompleteErrorObject$1(A.AsyncError$(type$.Object._as(error), type$.StackTrace._as(stackTrace)));
    },
  ...
  A._Future__propagateToListeners_handleWhenCompleteCallback_closure0.prototype = {
    call$2(e, s) {
      this.joinedResult._completeErrorObject$1(A.AsyncError$(type$.Object._as(e), type$.StackTrace._as(s)));
    },
    $signature: 13
  };
  ...
  A.FormatException.prototype = {
    toString$0(_) {
      ...
      if (typeof source == "string") {
        if (source.length > 78)
          source = J.$add$ns(B.JSString_methods.substring$2(source, 0, 75), "...");
        return report + "\n" + source;
      } else
        return report;
    },
  ...
  A.CanceledException.prototype = {
    toString$0(_) {
      var t1 = this.message;
      return J.get$isEmpty$asx(J.trim$0$s(t1)) ? A.S(this.get$runtimeType(0)) : A.S(this.get$runtimeType(0)) + ": " + A.S(t1);
    },
    $isException: 1,
    get$message() {
      return this.message;
  ...
  A.$jsify_closure0.prototype = {
    call$1(js) {
      ...
      type$.Object._as(js);
      t1 = type$.JSObject;
      t1 = A.JSAnyUtilityExtension_instanceof(js, A.JSObjectUnsafeUtilExtension_callMethodVarArgs(t1._as(A.JSObjectUnsafeUtilExtension___(A.globalContext(), "Object")), A.StringToJSString_get_toJS("getPrototypeOf"), [t1._as(A.JSObjectUnsafeUtilExtension___(A.globalContext(), "Int8Array"))], type$.JavaScriptFunction));
      if (t1) {
  ...
  A.$jsify_closure1.prototype = {
    call$1(obj) {
      var t1, t2, cached, jsifier, t3, len, jsArray, i, kjsifier, vjsifier, jsMap, jsSet, res, _this = this;
      if (obj == null)
        return null;
      t1 = _this.cache;
      ...
      if (type$.List_dynamic._is(obj) && !type$.TypedData._is(obj)) {
        if (type$.List_nullable_String._is(obj))
          ...
          jsifier = type$.List_nullable_BigInt._is(obj) ? A._patch___toJSBigInt$closure() : _this.squadronJsify.readLocal$1$0(type$.nullable_Object_Function_nullable_Object);
        ...
        for (t1 = type$.int, i = 0; i < len; ++i)
          A._callMethodUnchecked1(jsArray, "push", jsifier.call$1(t3.$index(obj, i)), t1);
        return jsArray;
      }
      if (type$.Map_dynamic_dynamic._is(obj)) {
        if (type$.Map_of_nullable_String_and_dynamic._is(obj))
          ...
          kjsifier = type$.Map_of_nullable_BigInt_and_dynamic._is(obj) ? A._patch___toJSBigInt$closure() : _this.squadronJsify.readLocal$1$0(type$.nullable_Object_Function_nullable_Object);
        if (type$.Map_of_dynamic_and_nullable_String._is(obj))
          ...
          vjsifier = type$.Map_of_dynamic_and_nullable_BigInt._is(obj) ? A._patch___toJSBigInt$closure() : _this.squadronJsify.readLocal$1$0(type$.nullable_Object_Function_nullable_Object);
        t3 = type$.JSObject;
      ...
      if (obj instanceof A._LinkedHashSet) {
        if (type$.Set_nullable_String._is(obj))
          ...
          jsifier = type$.Set_nullable_BigInt._is(obj) ? A._patch___toJSBigInt$closure() : _this.squadronJsify.readLocal$1$0(type$.nullable_Object_Function_nullable_Object);
        t3 = type$.JSObject;
  ...
  A.$dartify_closure.prototype = {
    call$1(js) {
      var t1, t2, cached, len, dartList, t3, i, keys, dartMap, t4, res, entry, values, dartSet, _this = this;
      ...
      if (cached != null)
        return cached;
      if (A.JSAnyUtilityExtension_instanceOfString(js, "Array")) {
      ...
      if (A.JSAnyUtilityExtension_instanceOfString(js, "Map")) {
        t3 = type$.JSObject;
        t3._as(js);
        ...
        for (t1 = type$.JSArray_nullable_Object, t2 = _this.squadronDartify, t3 = type$.nullable_Object_Function_nullable_Object, t4 = type$.nullable_Object; true;) {
          ...
          if (res == null || A.$JSIteratorResultExt_get_done(res))
            break;
      ...
      if (A.JSAnyUtilityExtension_instanceOfString(js, "Set")) {
        t3 = type$.JSObject;
        t3._as(js);
        ...
        for (t1 = _this.squadronDartify, t2 = type$.nullable_Object_Function_nullable_Object; true;) {
          ...
          if (res == null || A.$JSIteratorResultExt_get_done(res))
            break;
          dartSet.add$1(0, t1.readLocal$1$0(t2).call$1(A.$JSIteratorResultExt_get_value(res)));
        }
        return dartSet;
      }
      if (A.JSAnyUtilityExtension_typeofEquals(js, "bigint"))
  ...
  A.WorkerRunner.prototype = {
    ...
    _done$1(tokenRef) {
      ...
      tokenRef.release$0();
      if (J.$eq$(tokenRef.get$refCount(), 0))
