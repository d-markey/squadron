...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      WC: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      X: (o, p, v) => o[p] = v,
      ...
      ZC: (wasmFunction,f) => finalizeWrapper(f, function(x0,x1) { return wasmFunction(f,arguments.length,x0,x1) }),
      a: x0 => x0.random(),
      aB: o => {
        if (o === null || o === undefined) return 0;
      ...
      aC: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      b: o => o,
      bB: o => o,
      bC: (o, i) => o[i],
      c: o => {
      ...
      qC: Function.prototype.call.bind(String.prototype.toLowerCase),
      r: (x0,x1,x2) => new DataView(x0,x1,x2),
      rB: (o, p) => o[p],
      rC: Object.is,
      s: (o, p) => o[p],
      sB: () => globalThis,
      sC: (string, times) => string.repeat(times),
      t: x0 => new Array(x0),
      tB: x0 => globalThis.BigInt(x0),
      tC: (x0,x1) => x0.getRandomValues(x1),
      u: (x0,x1,x2) => { x0[x1] = x2 },
      uB: (o, c) => o instanceof c,
      uC: () => globalThis.crypto,
      ...
      vC: l => new DataView(new ArrayBuffer(l)),
      w: o => o.buffer,
      wB: o => o instanceof Array,
      wC: x0 => x0.port2,
      x: (b, o) => new DataView(b, o),
      xB: (a, i) => a[i],
      xC: (x0,x1) => { x0.onmessage = x1 },
