...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _278: o => o.length,
      _280: (o, i) => o[i],
      _281: f => f.dartFunction,
      _282: () => ({}),
      _283: () => [],
      _285: () => globalThis,
      _288: (o, p) => o[p],
      _289: (o, p, v) => o[p] = v,
      _290: (o, m, a) => o[m].apply(o, a),
      _292: o => String(o),
      _294: o => {
      ...
      _295: o => [o],
      _296: (o0, o1) => [o0, o1],
      _297: (o0, o1, o2) => [o0, o1, o2],
      _298: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _2700: x0 => x0.port1,
      _2701: x0 => x0.port2,
      _2704: (x0,x1) => x0.onmessage = x1,
      _2761: (x0,x1) => x0.onmessage = x1,
...
"trace test in worker",
"error test in worker",
"fatal",
"fatal test in worker",
"warning",
"warning test in worker",
"info",
"info test in worker",
"debug",
"debug test in worker",
"trace",
"verbose",
"wtf",
"No element",
