...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _385: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _409: x0 => x0.random(),
      _410: x0 => x0.random(),
      _414: () => globalThis.Math,
      _416: Function.prototype.call.bind(Number.prototype.toString),
      _2830: x0 => x0.port1,
      _2831: x0 => x0.port2,
      _2837: (x0,x1) => x0.onmessage = x1,
      _2899: (x0,x1) => x0.onmessage = x1,
