(async function () {
    ...
    let moduleInstance;
    try {
        const dartModulePromise = WebAssembly.compileStreaming(fetch('test_runner_wasm2wasm.dart.unopt.wasm'));
        const imports = {};
        dart2wasm_runtime = await import('./test_runner_wasm2wasm.dart.mjs');
