...
(function dartProgram() {
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(@)", "~(~())", "Null(@)", "Null()", "String(int)", "~(MessageEvent)", "Future<Null>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?)", "~(Object?,Object?)", "~(Event)", "~(@,@)", "Null(@,@)", "@(@,@)", "CancellationTokenReference()", "@(WorkerRequest)", "bool(WorkerRequest)", "~(WorkerRequest)", "List<@>(WorkerRequest)", "CacheService(WorkerRequest)", "bool(@)"],
