...
(function dartProgram() {
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(@)", "~(~())", "Null(@)", "Null()", "~(MessageEvent)", "Future<Null>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?)", "~(Object?,Object?)", "~(Event)", "~(@,@)", "Null(@,@)", "@(@,@)", "Future<@>(Map<@,@>)", "~(Map<@,@>)", "_CancellationTokenReference()", "@(WorkerRequest)", "bool(WorkerRequest)", "~(WorkerRequest)", "List<@>(WorkerRequest)", "CacheService(WorkerRequest)", "bool(@)"],
