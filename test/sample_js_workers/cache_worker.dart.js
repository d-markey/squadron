...
(function dartProgram() {
  ...
  O = {CacheService: function CacheService(t0) {
      ...
      _.__CacheService_operations = null;
  ...
  P = {
    ...
    Duration$(microseconds) {
      return new P.Duration(microseconds);
    },
  ...
  var holders = [C, E, H, J, K, M, N, O, P, Q, R, W, X, Y];
  ...
  O.CacheService.prototype = {
    ...
    get$operations() {
      var _this = this,
        t1 = _this.__CacheService_operations;
      if (t1 == null) {
        t1 = P.LinkedHashMap_LinkedHashMap$_literal([1, new O.CacheService_operations_closure(_this), 2, new O.CacheService_operations_closure0(_this), 3, new O.CacheService_operations_closure1(_this), 4, new O.CacheService_operations_closure2(_this)], type$.int, type$.dynamic_Function_WorkerRequest);
        if (_this.__CacheService_operations == null)
          _this.set$__CacheService_operations(t1);
        else
    ...
    set$__CacheService_operations(__CacheService_operations) {
      this.__CacheService_operations = type$.nullable_Map_of_int_and_dynamic_Function_WorkerRequest._as(__CacheService_operations);
    }
  };
  O.CacheService_operations_closure.prototype = {
    call$1(r) {
  ...
  O.CacheService_operations_closure1.prototype = {
    call$1(r) {
      var _null = null,
        ...
        t4 = t3.$index(t2, 0),
        t5 = t3.$index(t2, 1);
      t2 = t3.$index(t2, 2) == null ? _null : P.Duration$(H._asInt(t3.$index(t2, 2)));
      t3 = t1._cache;
      t2 = t2 == null ? _null : t2._duration;
      t3.$indexSet(0, t4, new O._CacheEntry(t5, t2 == null || t2 <= 0 ? _null : P.DateTime$_withValue(Date.now() + C.JSInt_methods._tdivFast$1(P.Duration$(t2)._duration, 1000), false)));
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(@)", "~(~())", "Null(@)", "Null()", "String(int)", "~(MessageEvent)", "Future<Null>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?)", "~(Object?,Object?)", "~(Event)", "~(@,@)", "Null(@,@)", "@(@,@)", "_CancellationTokenReference()", "@(WorkerRequest)", "bool(WorkerRequest)", "~(WorkerRequest)", "List<@>(WorkerRequest)", "CacheService(WorkerRequest)", "bool(@)"],
