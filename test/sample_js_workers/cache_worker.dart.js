...
(function dartProgram() {
  ...
  E = {
    main() {
      var t4,
        ...
        t3 = t2._as(new E.main_closure(scope, operations));
      type$.nullable_void_Function._as(null);
      t4 = type$.MessageEvent;
      W._EventStreamSubscription$(t1, "message", t3, false, t4);
      W._EventStreamSubscription$(scope, "message", t2._as(new E.main_closure0(com, operations)), false, t4);
    },
  ...
  var holders = [C, E, H, J, M, N, O, P, R, W, X, Y];
  ...
  O.CacheService_operations_closure2.prototype = {
    call$1(r) {
      ...
      t1 = this.$this;
      return [t1._hit, t1._miss, t1._expired, t1._cache.__js_helper$_length, t1._maxSize];
    },
    $signature: 26
  };
  ...
  E.main_closure0.prototype = {
    call$1(e) {
      Y.Worker_connect(X.WorkerRequest$deserialize(type$.Map_dynamic_dynamic._as(new P._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(type$.MessageEvent._as(e).data, true))).client, this.com.port2, this.operations, new O.CacheService(P.LinkedHashMap_LinkedHashMap$_empty(type$.dynamic, type$._CacheEntry)).get$operations());
    },
    $signature: 7
  };
  (function aliases() {
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(@)", "bool(Object)", "~(~())", "Null(@)", "Null()", "String(int)", "~(MessageEvent)", "Future<Null>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?)", "~(Object?,Object?)", "~(Event)", "~(@,@)", "Null(@,@)", "@(@,@)", "@(WorkerRequest)", "bool(WorkerRequest)", "~(WorkerRequest)", "List<@>(WorkerRequest)", "bool(@)"],
