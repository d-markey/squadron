...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var scope = type$.DedicatedWorkerGlobalScope._as(self),
        t1 = type$.nullable_void_Function_MessageEvent._as(new A.main_closure(scope));
      type$.nullable_void_Function._as(null);
      A._EventStreamSubscription$(scope, "message", t1, false, type$.MessageEvent);
    },
  ...
  A.main_closure.prototype = {
    call$1(e) {
      ...
      try {
        ...
        t2.mustCopy = true;
        B.DedicatedWorkerGlobalScope_methods.postMessage$1(this.scope, 'ECHO "' + A.S(t2.walk$1(t1)) + '"');
      } catch (exception) {
        error = A.unwrapException(exception);
        B.DedicatedWorkerGlobalScope_methods.postMessage$1(this.scope, "Error in Web Worker main program: " + A.S(error));
      }
    },
    $signature: 16
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A._Future__chainForeignFuture_closure0, A.MapBase_mapToString_closure, A._StructuredClone_walk_closure, A._StructuredClone_walk_closure0, A._AcceptStructuredClone_walk_closure]);
  ...
  A._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"NativeTypedArray":1,"StreamSubscription":1,"MapBase":2}'));
  var string$ = {
