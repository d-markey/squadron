  ...
  U = {
    main() {
      var scope = type$.DedicatedWorkerGlobalScope._as(self),
        t1 = type$.nullable_void_Function_MessageEvent._as(new U.main_closure(scope));
      type$.nullable_void_Function._as(null);
      W._EventStreamSubscription$(scope, "message", t1, false, type$.MessageEvent);
    },
  ...
  U.main_closure.prototype = {
    call$1(e) {
      ...
      try {
        ...
        t2.mustCopy = true;
        C.DedicatedWorkerGlobalScope_methods.postMessage$1(this.scope, 'ECHO "' + H.S(t2.walk$1(t1)) + '"');
      } catch (exception) {
        error = H.unwrapException(exception);
        C.DedicatedWorkerGlobalScope_methods.postMessage$1(this.scope, "Error in Web Worker main program: " + H.S(error));
      }
    },
    $signature: 16
  };
