...
(function dartProgram() {
  ...
  E = {
        ...
        return function $async$PrimeService__getPrimeCandidates($async$errorCode, $async$result) {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                _inRange = new E.PrimeService__getPrimeCandidates__inRange(min, max);
                $async$goto = H.boolConversionCheck(_inRange.call$1(2)) ? 2 : 3;
                break;
              case 2:
                // then
                $async$goto = 4;
              ...
              case 3:
                // join
                $async$goto = H.boolConversionCheck(_inRange.call$1(3)) ? 5 : 6;
                break;
              case 5:
                // then
                $async$goto = 7;
              ...
              case 6:
                // join
                p = 6 * C.JSInt_methods._tdivFast$1(min + 1, 6) - 1;
              case 8:
                // for condition
                if (!(p <= max)) {
                  // goto after for
                ...
                $async$goto = H.boolConversionCheck(_inRange.call$1(p)) ? 10 : 11;
                break;
              case 10:
                // then
                $async$goto = 12;
              ...
              case 11:
                // join
                p += 2;
                $async$goto = H.boolConversionCheck(_inRange.call$1(p)) ? 13 : 14;
                break;
              case 13:
                // then
                $async$goto = 15;
    ...
    PrimeService__isPrime(n) {
      ...
      if (n === 2 || n === 3)
        return true;
      if (n < 2 || C.JSInt_methods.$mod(n, 2) === 0 || C.JSInt_methods.$mod(n, 3) === 0)
        return false;
      for (t1 = E.PrimeService__getPrimeCandidates(5, C.JSNumber_methods.floor$0(Math.sqrt(n))), t1 = new P._SyncStarIterator(t1._outerHelper(), t1.$ti._eval$1("_SyncStarIterator<1>")); t1.moveNext$0();)
        if (C.JSInt_methods.$mod(n, t1.get$current()) === 0)
          return false;
      return true;
    },
    PrimeService: function PrimeService(t0) {
      this._cache = t0;
      this.__PrimeService_operations = null;
    },
  ...
  M = {
    ...
    CancelledException$(message, stackTrace) {
      var t1 = message == null ? "The task has been cancelled" : message;
      return new M.CancelledException(t1, stackTrace == null ? J.toString$0$(P.StackTrace_current()) : stackTrace);
    },
  ...
  O = {CacheClient: function CacheClient(t0) {
      this._remote = t0;
    }},
  P = {
  ...
  Q = {
    ...
    WorkerService_process$body(operations, message, monitor) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.dynamic),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], client, tokenRef, op, result, cancelled, res, e, e0, st, t1, t2, msg, tokenRef0, transfer, exception, request, $async$exception, $async$temp1;
          ...
          switch ($async$goto) {
            ...
            case 18:
              ...
              if (H.boolConversionCheck(cancelled)) {
                t2 = tokenRef;
                t2 = M.CancelledException$(t2 == null ? null : t2._worker_monitor$_message, null);
  ...
  R = {
    ...
    WorkerResponse$withError(exception, stackTrace) {
      ...
      if (stackTrace == null)
        ...
        t1 = stackTrace;
      return new R.WorkerResponse(false, t2, null, t1, exception instanceof M.CancelledException, exception instanceof M.TaskTimeoutException);
    },
  ...
  X = {
    ...
    WorkerRequest$deserialize(message) {
      var t4, _null = null,
        t1 = message == null,
        t2 = N.deserializeWorkerChannel(t1 ? _null : message.$index(0, "a")),
  ...
  Z = {
    main() {
      return X.bootstrap(new Z.main_closure(), null);
    },
    main_closure: function main_closure() {
    }
  };
  var holders = [C, E, H, J, K, M, N, O, P, Q, R, W, X, Y, Z];
  ...
  N.JsChannel.prototype = {
    sendRequest$1$2(command, args, $T) {
      var t3,
        ...
        com = new MessageChannel(),
        message = new X.WorkerRequest(N.deserializeWorkerChannel(com.port2), null, command, args).serialize$0(),
        t2 = N._getTransferables(message),
        transfer = P.List_List$of(t2, true, t2.$ti._eval$1("Iterable.E"));
      t2 = this._sendPort;
      t2.toString;
      C.MessagePort_methods.postMessage$2(t2, message, transfer);
      t2 = com.port1;
      t3 = type$.nullable_void_Function_MessageEvent._as(new N.JsChannel_sendRequest_closure(com, new P._AsyncCompleter(t1, $T._eval$1("_AsyncCompleter<0>")), $T));
      type$.nullable_void_Function._as(null);
      W._EventStreamSubscription$(t2, "message", t3, false, type$.MessageEvent);
      return t1;
    },
    $isChannel: 1
  };
  N.JsChannel_sendRequest_closure.prototype = {
    call$1($event) {
      var t6, t7,
        t1 = type$.Map_dynamic_dynamic._as(new P._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(type$.MessageEvent._as($event).data, true)),
        t2 = t1.$index(0, "a"),
        t3 = H._asStringQ(t1.$index(0, "b")),
        t4 = H._asStringQ(t1.$index(0, "c")),
        t5 = t1.$index(0, "e");
      t5 = H._asBool(t5 == null ? false : t5);
      t6 = t1.$index(0, "f");
      t6 = H._asBool(t6 == null ? false : t6);
      t1 = t1.$index(0, "d");
      t1 = H._asBool(t1 == null ? false : t1);
      this.com.port1.close();
      t7 = this.completer;
      if (t3 != null) {
        t1 = new R.WorkerResponse(t1, t3, t2, t4, t5, t6).get$exception();
        t1.toString;
  ...
  M.TaskTimeoutException.prototype = {};
  ...
  X.WorkerRequest.prototype = {
    serialize$0() {
      ...
      if (t1 === -3)
        ...
        t3 = type$.dynamic;
        if (t1 === -1) {
          t1 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
          t2 = _this.client;
          t1.$indexSet(0, "a", t2 == null ? null : t2._sendPort);
          t1.$indexSet(0, "b", -1);
          t2 = _this.args;
          if (J.get$isNotEmpty$ax(t2))
            t1.$indexSet(0, "c", t2);
          return t1;
        } else {
          ...
          t2.$indexSet(0, "b", t1);
          t1 = _this.args;
          if (J.get$isNotEmpty$ax(t1))
            t2.$indexSet(0, "c", t1);
          t1 = _this._cancelToken;
          if (t1 != null)
            t2.$indexSet(0, "d", P.LinkedHashMap_LinkedHashMap$_literal(["a", t1.token], t3, t3));
          return t2;
        }
      }
    }
  ...
  R.WorkerResponse.prototype = {
    ...
    get$exception() {
      ...
      if (t1 == null)
        return null;
      if (_this._cancelled)
        return M.CancelledException$(t1, _this._stackTrace);
      if (_this._timeout) {
        t2 = _this._stackTrace;
        return new M.TaskTimeoutException(t1, t2 == null ? J.toString$0$(P.StackTrace_current()) : t2);
      }
      t2 = _this._stackTrace;
      return new M.WorkerException(t1, t2 == null ? J.toString$0$(P.StackTrace_current()) : t2);
    }
  };
  O.CacheClient.prototype = {$isCache: 1};
  E.PrimeService.prototype = {
    isPrime$1(n) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.bool),
        $async$returnValue, $async$self = this, res, t1, t2, $async$temp1;
      var $async$isPrime$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$temp1 = H;
              $async$goto = 5;
              return P._asyncAwait(t1._remote.sendRequest$1$2(1, [n], type$.dynamic), $async$isPrime$1);
            case 5:
              // returning from await.
      ...
      return P._asyncStartSync($async$isPrime$1, $async$completer);
    },
    getPrimes$2(min, max) {
      var $async$getPrimes$2 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = E.PrimeService__getPrimeCandidates(min, max), t1 = new P._SyncStarIterator(t1._outerHelper(), t1.$ti._eval$1("_SyncStarIterator<1>"));
            case 3:
              // for condition
              if (!t1.moveNext$0()) {
                // goto after for
              ...
              $async$temp1 = H;
              $async$goto = 7;
              return P._asyncStarHelper($async$self.isPrime$1(t2), $async$getPrimes$2, $async$controller);
            case 7:
              // returning from await.
            ...
            case 5:
              ...
              return P._asyncStarHelper(P._IterationMarker_yieldSingle(t2), $async$getPrimes$2, $async$controller);
            case 8:
              // after yield
            case 6:
              // join
      ...
      var $async$goto = 0,
        $async$controller = P._makeAsyncStarStreamController($async$getPrimes$2, type$.int),
    ...
    get$operations() {
      var _this = this,
        t1 = _this.__PrimeService_operations;
      if (t1 == null) {
        t1 = P.LinkedHashMap_LinkedHashMap$_literal([1, new E.PrimeService_operations_closure(_this), 2, new E.PrimeService_operations_closure0(_this)], type$.int, type$.dynamic_Function_WorkerRequest);
        if (_this.__PrimeService_operations == null)
          _this.set$__PrimeService_operations(t1);
        else
    ...
    set$__PrimeService_operations(__PrimeService_operations) {
      this.__PrimeService_operations = type$.nullable_Map_of_int_and_dynamic_Function_WorkerRequest._as(__PrimeService_operations);
    }
  };
  E.PrimeService_operations_closure.prototype = {
    call$1(r) {
      return this.$this.isPrime$1(H._asInt(J.$index$ax(type$.WorkerRequest._as(r).args, 0)));
    },
    $signature: 24
  };
  E.PrimeService_operations_closure0.prototype = {
    call$1(r) {
      var t1 = type$.WorkerRequest._as(r).args,
        t2 = J.getInterceptor$ax(t1);
      return this.$this.getPrimes$2(H._asInt(t2.$index(t1, 0)), H._asInt(t2.$index(t1, 1)));
    },
    $signature: 25
  };
  E.PrimeService__getPrimeCandidates__inRange.prototype = {
    call$1(p) {
  ...
  Z.main_closure.prototype = {
    call$1(startRequest) {
      ...
      return new E.PrimeService(t1 == null ? null : new O.CacheClient(t1));
    },
    $signature: 27
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(H.Closure, [H.Closure0Args, H.ConstantStringMap_values_closure, H.Closure2Args, H.TearOffClosure, H.JsLinkedHashMap_values_closure, H.initHooks_closure, H.initHooks_closure1, P._AsyncRun__initializeScheduleImmediate_internalCallback, P._AsyncRun__initializeScheduleImmediate_closure, P._awaitOnObject_closure, P._asyncStarHelper_closure0, P._Future__chainForeignFuture_closure, P._Future__propagateToListeners_handleWhenCompleteCallback_closure, P.Stream_length_closure, P._RootZone_bindUnaryCallbackGuarded_closure, W._EventStreamSubscription_closure, P.promiseToFuture_closure, P.promiseToFuture_closure0, X.bootstrap_closure, X.bootstrap_closure1, N.JsChannel_sendRequest_closure, E.PrimeService_operations_closure, E.PrimeService_operations_closure0, E.PrimeService__getPrimeCandidates__inRange, Z.main_closure]);
    _inheritMany(H.Closure0Args, [H.nullFuture_closure, P._AsyncRun__scheduleImmediateJsOverride_internalCallback, P._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, P._TimerImpl_internalCallback, P._asyncStarHelper_closure, P._AsyncStarStreamController__resumeBody, P._AsyncStarStreamController__resumeBody_closure, P._AsyncStarStreamController_closure, P._AsyncStarStreamController_closure0, P._AsyncStarStreamController_closure1, P._AsyncStarStreamController__closure, P._Future__addListener_closure, P._Future__prependListeners_closure, P._Future__chainForeignFuture_closure1, P._Future__asyncCompleteWithValue_closure, P._Future__chainFuture_closure, P._Future__asyncCompleteError_closure, P._Future__propagateToListeners_handleWhenCompleteCallback, P._Future__propagateToListeners_handleValueCallback, P._Future__propagateToListeners_handleError, P.Stream_length_closure0, P._StreamController__subscribe_closure, P._StreamController__recordCancel_complete, P._AddStreamState_cancel_closure, P._BufferingStreamSubscription__sendError_sendError, P._BufferingStreamSubscription__sendDone_sendDone, P._PendingEvents_schedule_closure, P._rootHandleError_closure, P._RootZone_bindCallbackGuarded_closure, X.bootstrap_closure0, K.WorkerMonitor__getTokenRef_closure]);
    ...
    _inheritMany(N._MessagePort, [N.JsChannel, N.JsWorkerChannel]);
    _inheritMany(M.WorkerException, [M.CancelledException, M.TaskTimeoutException]);
...
;
    ...
    C.List_b = H._setArrayType(makeConstList(["b"]), type$.JSArray_String);
    C.Map_a9wo7 = new H.ConstantStringMap(1, {b: -3}, C.List_b, type$.ConstantStringMap_String_dynamic);
