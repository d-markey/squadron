...
(function dartProgram() {
            ...
            case 0:
              ...
              if (request.command === -2) {
                ...
                if (t1._worker_monitor$_exception == null)
                  t1._worker_monitor$_exception = M.CancelledException$(null, null, null);
                // goto return
                $async$goto = 1;
                break;
              }
              ...
              if (t1 === true) {
                J.reply$1$z(client, R.WorkerResponse$withError(M.CancelledException$("Cancelled", null, null), null));
                $async$next = [1];
                // goto finally
                $async$goto = 5;
                break;
    ...
    serialize$0() {
      ...
      if (t1 === -3)
        ...
        if (t1 === -1) {
          ...
          if (t1 != null)
            t2.$indexSet(0, "d", P.LinkedHashMap_LinkedHashMap$_literal(["a", t1.id], t3, t3));
          return t2;
        }
      }
    }
  ...
  R.WorkerResponse.prototype = {
    ...
    get$exception() {
      ...
      if (t1 == null)
        return null;
      if (_this._cancelled)
        return M.CancelledException$(t1, _this._stackTrace, null);
      else {
  ...
  (function inheritance() {
    ...
    _inherit(M.TaskTimeoutException, M.CancelledException);
