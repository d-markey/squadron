...
(function dartProgram() {
  ...
  var holders = [C, E, H, J, K, M, N, O, P, Q, R, W, X, Z];
  ...
  N.JsChannel.prototype = {
    sendRequest$1$2(command, args, $T) {
      var t3,
        ...
        com = new MessageChannel(),
        message = new X.WorkerRequest(N.deserializeWorkerChannel(com.port2), command, args, false, false).serialize$0(),
        t2 = N._getTransferables(message),
        transfer = P.List_List$of(t2, true, t2.$ti._eval$1("Iterable.E"));
      t2 = this._sendPort;
      t2.toString;
  ...
  N.JsChannel_sendRequest_closure.prototype = {
    call$1($event) {
      ...
      t5 = this.completer;
      if (t3 != null) {
        t1 = new R.WorkerResponse(t1, t3, t2, t4).get$exception();
        t1.toString;
    ...
    serialize$0() {
      ...
      if (_this.terminate)
        ...
        if (_this.connect) {
          ...
          t1.$indexSet(0, "a", t3 == null ? null : t3._sendPort);
          t1.$indexSet(0, "d", true);
          t2 = _this.args;
...
;
    ...
    C.List_e = H._setArrayType(makeConstList(["e"]), type$.JSArray_String);
    C.Map_Qsnip = new H.ConstantStringMap(1, {e: true}, C.List_e, type$.ConstantStringMap_String_dynamic);
