...
(function dartProgram() {
  ...
  Z = {
    main() {
      X.bootstrap(new Z.main_closure(), C.Map_empty);
    },
    main_closure: function main_closure() {
    }
  };
  var holders = [C, E, H, J, M, N, O, P, Q, R, W, X, Z];
  ...
  Z.main_closure.prototype = {
    call$1(startRequest) {
      ...
      return new E.PrimeService(cacheEndPoint == null ? null : new O.CacheClient(cacheEndPoint));
    },
    $signature: 28
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    var _;
    _instance_1_u(_ = P._StreamController.prototype, "get$_async$_add", "_async$_add$1", 7);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null()", "Null(@)", "~(@)", "~(Object,StackTrace)", "bool(Object)", "~(~())", "~(Object?)", "~(MessageEvent)", "Future<Null>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "_Future<@>?()", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?,Object?)", "~(Event)", "~(@,@)", "Null(@,@)", "@(@,@)", "Future<~>(MessageEvent)", "Future<bool>(WorkerRequest)", "Stream<int>(WorkerRequest)", "bool(int)", "PrimeService(WorkerRequest)", "bool(@)"],
