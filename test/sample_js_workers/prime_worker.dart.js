...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
          ...
          switch ($async$goto) {
            case 0:
              ...
              if (request.command === -2) {
                ...
                if (t1.__bootstrapper_stub$_exception == null)
                  t1.__bootstrapper_stub$_exception = A.CancelledException$(null, null, null, null);
                // goto return
                $async$goto = 1;
                break;
              }
              ...
              if (t1 === true) {
                J.reply$1$z(client, A.WorkerResponse$withError(A.CancelledException$(null, "Cancelled", null, null), null));
                $async$next = [1];
                // goto finally
                $async$goto = 5;
                break;
            ...
            case 18:
              ...
              if (t2 === true) {
                ...
                t2 = A.WorkerResponse$withError(new A.CancelledException("Cancelled", t2, null, null), null);
                t2._error != null;
    ...
    TaskTimeoutException: function TaskTimeoutException(t0, t1, t2, t3) {
      var _ = this;
      _.message = t0;
      _.stackTrace = t1;
      _.workerId = t2;
    ...
    WorkerRequest$deserialize(message) {
      ...
      t1 = A.deserializeWorkerChannel(t1);
    ...
    WorkerResponse$withError(exception, stackTrace) {
      ...
      if (stackTrace == null)
        ...
        t1 = stackTrace;
      return new A.WorkerResponse(false, t2, null, t1, exception instanceof A.CancelledException, exception instanceof A.TaskTimeoutException);
    },
    ...
    CacheClient: function CacheClient(t0) {
      this._remote = t0;
    },
    PrimeService__getPrimeCandidates($async$min, $async$max) {
      return A._makeSyncStarIterable(function() {
        var min = $async$min,
          max = $async$max;
        var $async$goto = 0, $async$handler = 1, $async$currentError, p, _inRange;
        return function $async$PrimeService__getPrimeCandidates($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                _inRange = new A.PrimeService__getPrimeCandidates__inRange(min, max);
                $async$goto = A.boolConversionCheck(_inRange.call$1(2)) ? 2 : 3;
                break;
              case 2:
                // then
                $async$goto = 4;
              ...
              case 3:
                // join
                $async$goto = A.boolConversionCheck(_inRange.call$1(3)) ? 5 : 6;
                break;
              case 5:
                // then
                $async$goto = 7;
              ...
              case 6:
                // join
                p = 6 * B.JSInt_methods._tdivFast$1(min + 1, 6) - 1;
              case 8:
                // for condition
                if (!(p <= max)) {
                  // goto after for
                ...
                $async$goto = A.boolConversionCheck(_inRange.call$1(p)) ? 10 : 11;
                break;
              case 10:
                // then
                $async$goto = 12;
              ...
              case 11:
                // join
                p += 2;
                $async$goto = A.boolConversionCheck(_inRange.call$1(p)) ? 13 : 14;
                break;
              case 13:
                // then
                $async$goto = 15;
    ...
    PrimeService__isPrime(n) {
      var t1;
      if (n === 2 || n === 3)
        return true;
      if (n < 2 || B.JSInt_methods.$mod(n, 2) === 0 || B.JSInt_methods.$mod(n, 3) === 0)
        return false;
      for (t1 = A.PrimeService__getPrimeCandidates(5, B.JSNumber_methods.floor$0(Math.sqrt(n))), t1 = new A._SyncStarIterator(t1._outerHelper(), t1.$ti._eval$1("_SyncStarIterator<1>")); t1.moveNext$0();)
        if (B.JSInt_methods.$mod(n, t1.get$current()) === 0)
          return false;
      return true;
    },
    PrimeService: function PrimeService(t0) {
      this._cache = t0;
      this.__PrimeService_operations = $;
    },
    PrimeService_operations_closure: function PrimeService_operations_closure(t0) {
      this.$this = t0;
    },
    PrimeService_operations_closure0: function PrimeService_operations_closure0(t0) {
      this.$this = t0;
    },
    PrimeService__getPrimeCandidates__inRange: function PrimeService__getPrimeCandidates__inRange(t0, t1) {
      this.min = t0;
      this.max = t1;
    },
    main() {
  ...
  A._StreamController.prototype = {
    ...
    _subscribe$4(onData, onError, onDone, cancelOnError) {
      ...
      subscription = new A._ControllerSubscription(_this, t4, t5, type$.void_Function._as(onDone), t2, t3, t1._eval$1("_ControllerSubscription<1>"));
  ...
  A._JsChannel.prototype = {
    sendRequest$1$2(command, args, $T) {
      return this.sendRequest$body$_JsChannel(command, args, $T, $T);
    },
    sendRequest$body$_JsChannel(command, args, $T, $async$type) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter($async$type),
        $async$returnValue, $async$self = this, t1, t2, t3, t4, t5, t6, com, $async$temp1, $async$temp2;
      var $async$sendRequest$1$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              com = new MessageChannel();
              $async$self._postRequest$1(new A.WorkerRequest(A.deserializeWorkerChannel(com.port2), null, command, args, null, null));
              t1 = new A._EventStream(com.port1, "message", false, type$._EventStream_MessageEvent);
              $async$temp1 = type$.Map_dynamic_dynamic;
              $async$temp2 = new A._AcceptStructuredCloneDart2Js([], []);
              $async$goto = 3;
              return A._asyncAwait(t1.get$first(t1), $async$sendRequest$1$2);
            case 3:
              // returning from await.
              t1 = $async$temp1._as($async$temp2.convertNativeToDart_AcceptStructuredClone$2$mustCopy($async$result.data, true));
              t2 = t1.$index(0, "a");
              t3 = A._asStringQ(t1.$index(0, "b"));
              t4 = A._asStringQ(t1.$index(0, "c"));
              t5 = t1.$index(0, "e");
              t5 = A._asBool(t5 == null ? false : t5);
              t6 = t1.$index(0, "f");
              t6 = A._asBool(t6 == null ? false : t6);
              t1 = t1.$index(0, "d");
              t1 = A._asBool(t1 == null ? false : t1);
              $async$returnValue = $T._as(t3 != null ? A.throwExpression(new A.WorkerResponse(t1, t3, t2, t4, t5, t6).get$exception()) : t2);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$sendRequest$1$2, $async$completer);
    },
    $isChannel: 1
  };
    ...
    serialize$0() {
      ...
      if (t1 === -3)
        ...
        if (t1 === -1) {
          ...
          if (t1 != null)
            t2.$indexSet(0, "d", A.LinkedHashMap_LinkedHashMap$_literal(["a", t1.id], t3, t3));
          return t2;
        }
      }
    }
  ...
  A.WorkerResponse.prototype = {
    ...
    get$exception() {
      ...
      if (t1 == null)
        return _null;
      if (_this._cancelled)
        return A.CancelledException$(_null, t1, _this._stackTrace, _null);
      else {
        t2 = _this._stackTrace;
        if (_this._timeout)
          return new A.TaskTimeoutException(t1, t2 == null ? J.toString$0$(A.StackTrace_current()) : t2, _null, _null);
        else
          return A.WorkerException$(t1, _null, t2, _null);
      }
    }
  };
  A.CacheClient.prototype = {$isCache: 1};
  A.PrimeService.prototype = {
    isPrime$1(n) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.bool),
        $async$returnValue, $async$self = this, res, t1, t2, $async$temp1;
      var $async$isPrime$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$temp1 = A;
              $async$goto = 5;
              return A._asyncAwait(t1._remote.sendRequest$1$2(1, [n], type$.dynamic), $async$isPrime$1);
            case 5:
              // returning from await.
              if ($async$temp1._asBoolQ($async$result) === true) {
            ...
            case 4:
              // join
              res = A.PrimeService__isPrime(n);
              if (!t2) {
                t1 = t1._remote;
                t1.sendRequest$1$2(3, [n, res, null], type$.dynamic);
              }
      ...
      return A._asyncStartSync($async$isPrime$1, $async$completer);
    },
    getPrimes$2(min, max) {
      var $async$getPrimes$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = A.PrimeService__getPrimeCandidates(min, max), t1 = new A._SyncStarIterator(t1._outerHelper(), t1.$ti._eval$1("_SyncStarIterator<1>"));
            case 3:
              // for condition
              if (!t1.moveNext$0()) {
                // goto after for
              ...
              $async$temp1 = A;
              $async$goto = 7;
              return A._asyncStarHelper($async$self.isPrime$1(t2), $async$getPrimes$2, $async$controller);
            case 7:
              // returning from await.
            ...
            case 5:
              ...
              return A._asyncStarHelper(A._IterationMarker_yieldSingle(t2), $async$getPrimes$2, $async$controller);
            case 8:
              // after yield
            case 6:
              // join
      ...
      var $async$goto = 0,
        $async$controller = A._makeAsyncStarStreamController($async$getPrimes$2, type$.int),
        $async$nextWhenCanceled, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, t1, t2, $async$temp1;
      return A._streamOfController($async$controller);
    },
    get$operations() {
      var result, _this = this,
        value = _this.__PrimeService_operations;
      if (value === $) {
        result = A.LinkedHashMap_LinkedHashMap$_literal([1, new A.PrimeService_operations_closure(_this), 2, new A.PrimeService_operations_closure0(_this)], type$.int, type$.dynamic_Function_WorkerRequest);
        A._lateInitializeOnceCheck(_this.__PrimeService_operations, "operations");
        _this.set$__PrimeService_operations(result);
        value = result;
      }
      return value;
    },
    set$__PrimeService_operations(__PrimeService_operations) {
      this.__PrimeService_operations = type$.Map_of_int_and_dynamic_Function_WorkerRequest._as(__PrimeService_operations);
    }
  };
  A.PrimeService_operations_closure.prototype = {
    call$1(r) {
      return this.$this.isPrime$1(A._asInt(J.$index$ax(type$.WorkerRequest._as(r).args, 0)));
    },
    $signature: 26
  };
  A.PrimeService_operations_closure0.prototype = {
    call$1(r) {
      var t1 = type$.WorkerRequest._as(r).args,
        t2 = J.getInterceptor$ax(t1);
      return this.$this.getPrimes$2(A._asInt(t2.$index(t1, 0)), A._asInt(t2.$index(t1, 1)));
    },
    $signature: 27
  };
  A.PrimeService__getPrimeCandidates__inRange.prototype = {
    call$1(p) {
  ...
  A.main_closure.prototype = {
    call$1(startRequest) {
      var t1 = startRequest.args,
        t2 = J.getInterceptor$asx(t1);
      t1 = t2.get$isEmpty(t1) ? null : t2.$index(t1, 0);
      if (t1 == null)
        t1 = null;
      else {
        t2 = new A._JsChannel();
      ...
      return new A.PrimeService(t1 == null ? null : new A.CacheClient(t1));
    },
    $signature: 29
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _instance_0_u(_, "get$_onResume", "_onResume$0", 0);
    _instance_1_u(_ = A._StreamIterator.prototype, "get$_async$_onData", "_async$_onData$1", 6);
    _instance_2_u(_, "get$_onError", "_onError$2", 4);
    _instance_0_u(_, "get$_onDone", "_onDone$0", 0);
    _static_1(A, "channel___isObject$closure", "_isObject0", 30);
  })();
