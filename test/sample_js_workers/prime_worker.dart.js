...
(function dartProgram() {
  ...
  Y = {
    Worker_connect(client, channelInfo, operations, serviceOperations) {
      ...
      try {
        t1 = operations.__js_helper$_length;
        if (t1 !== 0) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$handler = 4;
              if (operations.__js_helper$_length === 0) {
  ...
  Z = {
    main() {
      var t4,
        ...
        t3 = t2._as(new Z.main_closure(scope, operations));
      type$.nullable_void_Function._as(null);
      t4 = type$.MessageEvent;
      W._EventStreamSubscription$(t1, "message", t3, false, t4);
      W._EventStreamSubscription$(scope, "message", t2._as(new Z.main_closure0(com, operations)), false, t4);
    },
  ...
  var holders = [C, E, H, J, M, N, O, P, R, W, X, Y, Z];
  ...
  H.MappedIterable.prototype = {
    get$iterator(_) {
      var t1 = this.__internal$_iterable,
        t2 = t1._map,
        t3 = H._instanceType(this);
      return new H.MappedIterator(H.LinkedHashMapKeyIterator$(t2, t2._modifications, t1.$ti._precomputed1), this._f, t3._eval$1("@<1>")._bind$1(t3._rest[1])._eval$1("MappedIterator<1,2>"));
    },
    get$length(_) {
      return this.__internal$_iterable._map.__js_helper$_length;
    },
    get$isEmpty(_) {
      return this.__internal$_iterable._map.__js_helper$_length === 0;
    },
    elementAt$1(_, index) {
  ...
  P.SetMixin.prototype = {
    ...
    elementAt$1(_, index) {
      ...
      for (t1 = P._LinkedHashSetIterator$(_this, _this._collection$_modifications, _this.$ti._precomputed1), t2 = t1.$ti._precomputed1, elementIndex = 0; t1.moveNext$0();) {
  ...
  N.JsChannel.prototype = {
    sendRequest$1$2(command, args, $T) {
      var t3,
        ...
        com = new MessageChannel(),
        message = new X.WorkerRequest(N._deserializeChannel(com.port2), command, args, false, false).serialize$0(),
        t2 = N._getTransferables(message),
        transfer = P.List_List$of(t2, true, t2.$ti._eval$1("Iterable.E"));
      t2 = this._sendPort;
      t2.toString;
  ...
  N.JsChannel_sendRequest_closure.prototype = {
    call$1($event) {
      ...
      t5 = this.completer;
      if (t3 != null) {
        t1 = new R.WorkerResponse(t3, t4, t2, t1).get$exception();
        t1.toString;
        t5.completeError$1(t1);
      } else
        t5.complete$1(this.T._eval$1("0/?")._as(t2));
    },
    $signature: 5
  };
  ...
  X.WorkerRequest.prototype = {
    ...
    serialize$0() {
      var t1, _this = this;
      if (_this.terminate)
        return P.LinkedHashMap_LinkedHashMap$_literal(["e", true], type$.String, type$.dynamic);
      else {
        t1 = _this.client;
        if (_this.connect) {
          t1 = t1 == null ? null : t1._sendPort;
          return P.LinkedHashMap_LinkedHashMap$_literal(["a", t1, "d", true, "c", _this.args], type$.String, type$.dynamic);
        } else {
          t1 = t1 == null ? null : t1._sendPort;
          return P.LinkedHashMap_LinkedHashMap$_literal(["a", t1, "b", _this.command, "c", _this.args], type$.String, type$.dynamic);
        }
      }
    }
  };
  R.WorkerResponse.prototype = {
    get$exception() {
      var t1 = this._error;
      return t1 != null ? M.WorkerException$(t1, this._stackTrace) : null;
    },
    toString$0(_) {
      var t2, _this = this,
        t1 = _this._error;
      if (t1 != null) {
        t2 = _this.get$exception();
        t2.toString;
  ...
  Z.main_closure0.prototype = {
    call$1(e) {
      var startRequest = X.WorkerRequest$deserialize(type$.Map_dynamic_dynamic._as(new P._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(type$.MessageEvent._as(e).data, true))),
        t1 = startRequest.args,
        t2 = J.getInterceptor$asx(t1),
        cacheEndPoint = t2.get$isEmpty(t1) ? null : N._deserializeChannel(t2.$index(t1, 0)),
        cache = cacheEndPoint == null ? null : new O.CacheClient(cacheEndPoint);
      Y.Worker_connect(startRequest.client, this.com.port2, this.operations, new E.PrimeService(cache).get$operations());
    },
    $signature: 5
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    var _;
    _instance_1_u(_ = P._StreamController.prototype, "get$_async$_add", "_async$_add$1", 8);
