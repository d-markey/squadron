...
(function dartProgram() {
  ...
  var A = {
    PiDigitsServiceImpl_piTerm(j, n) {
      ...
      for (r = j, s = 0, k = 0; k <= n; ++k) {
        ...
        s -= C.JSNumber_methods.floor$0(s);
        r += 8;
      }
      k = n + 1;
      r = 8 * k + j;
    ...
    PiDigitsServiceImpl_powMod(a, b, m) {
      ...
      if (b === 0)
        ...
        temp = A.PiDigitsServiceImpl_powMod(a, C.JSInt_methods._tdivFast$1(b, 2), m);
        t1 = temp * temp;
        tempo = C.JSInt_methods.$mod(b, 2) === 0 ? C.JSInt_methods.$mod(t1, m) : C.JSInt_methods.$mod(C.JSInt_methods.$mod(t1, m) * a, m);
      }
      return tempo;
    },
    PiDigitsServiceImpl: function PiDigitsServiceImpl() {
      this.__PiDigitsServiceImpl_operations = null;
    },
  ...
  var holders = [A, B, C, H, J, K, M, N, P, Q, R, W, X, Y];
  ...
  A.PiDigitsServiceImpl.prototype = {
    getNDigits$2(start, n) {
      var $async$getNDigits$2 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              return P._asyncStarHelper(P._IterationMarker_yieldSingle($async$self.getNth$1(i)), $async$getNDigits$2, $async$controller);
            case 6:
              // after yield
            case 4:
              // for update
      ...
      var $async$goto = 0,
        $async$controller = P._makeAsyncStarStreamController($async$getNDigits$2, type$.int),
    ...
    getNth$1(n) {
      ...
      return C.JSNumber_methods.toInt$0((x - C.JSNumber_methods.floor$0(x)) * 16);
    },
    get$operations() {
      var _this = this,
        t1 = _this.__PiDigitsServiceImpl_operations;
      if (t1 == null) {
        t1 = P.LinkedHashMap_LinkedHashMap$_literal([1, new A.PiDigitsServiceImpl_operations_closure(_this), 2, new A.PiDigitsServiceImpl_operations_closure0(_this)], type$.int, type$.dynamic_Function_WorkerRequest);
        if (_this.__PiDigitsServiceImpl_operations == null)
          _this.set$__PiDigitsServiceImpl_operations(t1);
        else
    ...
    set$__PiDigitsServiceImpl_operations(__PiDigitsServiceImpl_operations) {
      this.__PiDigitsServiceImpl_operations = type$.nullable_Map_of_int_and_dynamic_Function_WorkerRequest._as(__PiDigitsServiceImpl_operations);
    }
  };
  A.PiDigitsServiceImpl_operations_closure.prototype = {
    call$1(r) {
      return this.$this.getNth$1(H._asInt(J.$index$ax(type$.WorkerRequest._as(r).args, 0)));
    },
    $signature: 24
  };
  A.PiDigitsServiceImpl_operations_closure0.prototype = {
    call$1(r) {
      ...
      return this.$this.getNDigits$2(H._asInt(t2.$index(t1, 0)), H._asInt(t2.$index(t1, 1)));
    },
    $signature: 25
  };
  ...
  (function installTearOffs() {
    ...
    var _;
    _instance_1_u(_ = P._StreamController.prototype, "get$_add", "_add$1", 6);
    ...
    _instance_0_u(_, "get$_onResume", "_onResume$0", 0);
    _instance_1_u(_ = P._StreamIterator.prototype, "get$_async$_onData", "_async$_onData$1", 6);
