...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    PiDigitsServiceImpl_piTerm(j, n) {
      var r, s, k, t, newt;
      for (r = j, s = 0, k = 0; k <= n; ++k) {
        s += A.PiDigitsServiceImpl_powMod(16, n - k, r) / r;
    ...
    PiDigitsServiceImpl_powMod(a, b, m) {
      var tempo, temp, t1;
      if (b === 0)
        tempo = 1;
      else if (b === 1)
        ...
        temp = A.PiDigitsServiceImpl_powMod(a, B.JSInt_methods._tdivFast$1(b, 2), m);
        t1 = temp * temp;
        tempo = B.JSInt_methods.$mod(b, 2) === 0 ? B.JSInt_methods.$mod(t1, m) : B.JSInt_methods.$mod(B.JSInt_methods.$mod(t1, m) * a, m);
      }
      return tempo;
    },
    PiDigitsServiceImpl: function PiDigitsServiceImpl() {
      this.__PiDigitsServiceImpl_operations = $;
    },
    PiDigitsServiceImpl_operations_closure: function PiDigitsServiceImpl_operations_closure(t0) {
      this.$this = t0;
    },
    PiDigitsServiceImpl_operations_closure0: function PiDigitsServiceImpl_operations_closure0(t0) {
      this.$this = t0;
    },
    main() {
  ...
  A.PiDigitsServiceImpl.prototype = {
    getNDigits$2(start, n) {
      var $async$getNDigits$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              return A._asyncStarHelper(A._IterationMarker_yieldSingle($async$self.getNth$1(i)), $async$getNDigits$2, $async$controller);
            case 6:
              // after yield
            case 4:
              // for update
      ...
      var $async$goto = 0,
        $async$controller = A._makeAsyncStarStreamController($async$getNDigits$2, type$.int),
        $async$nextWhenCanceled, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, i, end;
    ...
    getNth$1(n) {
      ...
      if (n < 0)
        return -1;
      --n;
      x = 4 * A.PiDigitsServiceImpl_piTerm(1, n) - 2 * A.PiDigitsServiceImpl_piTerm(4, n) - A.PiDigitsServiceImpl_piTerm(5, n) - A.PiDigitsServiceImpl_piTerm(6, n);
      return B.JSNumber_methods.toInt$0((x - B.JSNumber_methods.floor$0(x)) * 16);
    },
    get$operations() {
      var result, _this = this,
        value = _this.__PiDigitsServiceImpl_operations;
      if (value === $) {
        result = A.LinkedHashMap_LinkedHashMap$_literal([1, new A.PiDigitsServiceImpl_operations_closure(_this), 2, new A.PiDigitsServiceImpl_operations_closure0(_this)], type$.int, type$.dynamic_Function_WorkerRequest);
        A._lateInitializeOnceCheck(_this.__PiDigitsServiceImpl_operations, "operations");
        _this.set$__PiDigitsServiceImpl_operations(result);
        value = result;
      }
      return value;
    },
    set$__PiDigitsServiceImpl_operations(__PiDigitsServiceImpl_operations) {
      this.__PiDigitsServiceImpl_operations = type$.Map_of_int_and_dynamic_Function_WorkerRequest._as(__PiDigitsServiceImpl_operations);
    }
  };
  A.PiDigitsServiceImpl_operations_closure.prototype = {
    call$1(r) {
      return this.$this.getNth$1(A._asInt(J.$index$ax(type$.WorkerRequest._as(r).args, 0)));
    },
    $signature: 26
  };
  A.PiDigitsServiceImpl_operations_closure0.prototype = {
    call$1(r) {
      var t1 = type$.WorkerRequest._as(r).args,
        t2 = J.getInterceptor$ax(t1);
      return this.$this.getNDigits$2(A._asInt(t2.$index(t1, 0)), A._asInt(t2.$index(t1, 1)));
    },
    $signature: 27
  };
  A.main_closure.prototype = {
    call$1(startRequest) {
      return new A.PiDigitsServiceImpl();
    },
    $signature: 28
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "channel___isObject$closure", "_isObject0", 29);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null()", "Null(@)", "~(@)", "~(Object,StackTrace)", "~(~())", "~(Object?)", "~(MessageEvent)", "Future<Null>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "_Future<@>?()", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?,Object?)", "~(Event)", "~(@,@)", "Null(@,@)", "@(@,@)", "Future<@>(Map<@,@>)", "~(Map<@,@>)", "_CancellationTokenReference()", "int(WorkerRequest)", "Stream<int>(WorkerRequest)", "PiDigitsServiceImpl(WorkerRequest)", "bool(@)"],
