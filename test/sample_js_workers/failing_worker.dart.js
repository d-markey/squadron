...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
          ...
          switch ($async$goto) {
            case 0:
              ...
              if (message == null) {
                t1 = $.Squadron__logger;
                if (t1 != null)
                  t1._log$2(1000, "null message; for workers running in an Isolate, this may be due to the run() function not receiving the command parameter.");
                // goto return
                $async$goto = 1;
                break;
              }
              ...
              t1 = "connecting worker with arguments " + message.toString$0(0);
              t2 = $.Squadron__logger;
              if (t2 != null)
                t2._log$2(500, t1);
    ...
    WorkerRunner_process$body(operations, message, monitor) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], request, client, tokenRef, op, result, res, e, e0, st, msg, t2, exception, t1, $async$exception, $async$temp1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = $.Squadron__logger;
              if (t1 != null)
                t1._log$2(500, new A.WorkerRunner_process_closure(message));
    ...
    WorkerRunner_process_closure: function WorkerRunner_process_closure(t0) {
      this.message = t0;
    },
  ...
  A.WorkerRunner_process_closure.prototype = {
    call$0() {
  ...
  A.bootstrap_closure0.prototype = {
    call$0() {
      ...
      if (t1 != null)
        t1._log$2(900, "terminating Web worker");
    ...
    _log$2(level, message) {
      ...
      if (level >= this.logLevel) {
        ...
        if (type$.Iterable_dynamic._is(message)) {
          ...
          lines = A.List_List$of(new A.WhereIterable(new A.ExpandIterable(t2, t3._eval$1("Iterable<String>(Iterable.E)")._as(new A.BaseSquadronLogger__log_closure0()), t4), t4._eval$1("bool(Iterable.E)")._as(new A.BaseSquadronLogger__log_closure1()), t5), true, t5._eval$1("Iterable.E"));
        } else {
          if (message == null)
            lines = null;
          else {
            t2 = type$.WhereIterable_String;
            t2 = A.List_List$of(new A.WhereIterable(A._setArrayType(J.toString$0$(message).split("\n"), type$.JSArray_String), type$.bool_Function_String._as(new A.BaseSquadronLogger__log_closure2()), t2), true, t2._eval$1("Iterable.E"));
            lines = t2;
          }
          if (lines == null)
            lines = B.List_empty0;
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(@)", "~(~())", "Null(@)", "Null()", "~(MessageEvent)", "bool(String)", "Future<Null>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?)", "~(Object?,Object?)", "~(Event)", "~(@,@)", "Null(@,@)", "@(@,@)", "_CancellationTokenReference()", "String()", "String(@)", "List<String>(String)", "0&(WorkerRequest)", "bool(@)"],
