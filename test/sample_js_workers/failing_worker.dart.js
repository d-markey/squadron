...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = startRequest.logLevel;
              t1.toString;
              t2 = $.Squadron__logger;
              if (t2 != null)
                t2.logLevel = t1;
              $.Squadron__logLevel = t1;
              t1 = "received connection request " + message.toString$0(0);
              t2 = $.Squadron__logger;
              if (t2 != null)
                t2._log$2(700, t1);
              ...
              if (client == null) {
                t1 = $.Squadron__logger;
                if (t1 != null)
                  t1._log$2(1000, "missing client for connection request");
                // goto return
                $async$goto = 1;
                break;
              }
              ...
              if (t1) {
                t1 = $.Squadron__logger;
                if (t1 != null)
                  t1._log$2(1000, "already connected");
    ...
    _WorkerRunner_process$body(operations, message, monitor) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], request, client, tokenRef, op, result, res, e, e0, st, msg, t2, t3, t4, exception, t1, $async$exception, $async$temp1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = $.Squadron__logger;
              if (t1 != null)
                t1._log$2(300, new A._WorkerRunner_process_closure(message));
              ...
              if (client == null) {
                t1 = "missing client for request: " + A.S(request);
                t2 = $.Squadron__logger;
                if (t2 != null)
                  t2._log$2(1000, t1);
                // goto return
    ...
    _WorkerRunner_process_closure: function _WorkerRunner_process_closure(t0) {
      this.message = t0;
    },
    ...
    ConsoleSquadronLogger: function ConsoleSquadronLogger() {
      this.logLevel = 1000;
    },
    ...
    WorkerRequest$deserialize(message) {
      ...
      if (t6 == null)
        t6 = B.List_empty0;
      type$.List_dynamic._as(t6);
      return new A.WorkerRequest(t1, t2, t3, t4, t5);
    },
  ...
  A._WorkerRunner_process_closure.prototype = {
    call$0() {
      return "processing request " + this.message.toString$0(0);
    },
    $signature: 25
  };
  A.bootstrap_closure.prototype = {
    call$0() {
      var t1 = $.Squadron__logger;
      if (t1 != null)
        t1._log$2(700, "terminating Web worker");
      t1 = this.com;
      t1.port1.close();
      t1.port2.close();
      this.scope.close();
  ...
  A._MessagePort.prototype = {
    _postResponse$1(res) {
      ...
      try {
        ...
        t1 = "Failed to post response message: " + A.S(ex);
        t2 = $.Squadron__logger;
        if (t2 != null)
          t2._log$2(1000, t1);
        t1 = "   message is " + A.S(message) + " with tranferables = " + A.S(transfer);
        t2 = $.Squadron__logger;
        if (t2 != null)
          t2._log$2(1000, t1);
        throw exception;
  ...
  A.BaseSquadronLogger.prototype = {
    _log$2(level, message) {
      var t1, t2, t3, t4, lines;
      if (level >= this.logLevel) {
        if (type$.Function._is(message))
          message = message.call$0();
        t1 = "[" + new A.DateTime(Date.now(), false).toUtc$0().toIso8601String$0() + "] [" + A.SquadronLogLevel_getName(level) + "] [";
        t2 = $.Squadron__id;
        t1 += t2 == null ? "<undefined>" : t2;
        if (type$.Iterable_dynamic._is(message)) {
          t2 = J.map$1$1$ax(message, new A.BaseSquadronLogger__log_closure(), type$.String);
          t3 = A._instanceType(t2);
          t4 = t3._eval$1("ExpandIterable<Iterable.E,String>");
          lines = new A.WhereIterable(new A.ExpandIterable(t2, t3._eval$1("Iterable<String>(Iterable.E)")._as(new A.BaseSquadronLogger__log_closure0()), t4), t4._eval$1("bool(Iterable.E)")._as(new A.BaseSquadronLogger__log_closure1()), t4._eval$1("WhereIterable<Iterable.E>"));
        } else {
          lines = message == null ? null : new A.WhereIterable(A._setArrayType(J.toString$0$(message).split("\n"), type$.JSArray_String), type$.bool_Function_String._as(new A.BaseSquadronLogger__log_closure2()), type$.WhereIterable_String);
          if (lines == null)
            lines = B.List_empty;
        }
        for (t2 = J.get$iterator$ax(lines); t2.moveNext$0();) {
          t3 = t2.get$current();
          A.printString(t1 + "] " + t3);
        }
      }
  ...
  A.ConsoleSquadronLogger.prototype = {};
  ...
  A.main_closure.prototype = {
    call$1(startRequest) {
      var t1 = new A.ConsoleSquadronLogger(),
        t2 = $.Squadron__logger,
        level = t2 == null ? null : t2.logLevel;
      if (level == null)
        level = $.Squadron__logLevel;
      $.Squadron__logger = t1;
      t1.logLevel = level;
  ...
  (function installTearOffs() {
    ...
    var _;
    _instance_1_u(_ = A._StreamIterator.prototype, "get$_async$_onData", "_async$_onData$1", 16);
  ...
  (function inheritance() {
    ...
    _inherit(A.ConsoleSquadronLogger, A.BaseSquadronLogger);
...
;
  ...
  (function staticFields() {
    ...
    $.Squadron__logLevel = 2000;
    $.Squadron__logger = null;
    $.Squadron__id = null;
  })();
