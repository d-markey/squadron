...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    SampleService: function SampleService() {
      this.__SampleService_operations = $;
    },
  ...
  A.SampleService.prototype = {
    ...
    delayedIdentity$1(n) {
      var $async$goto = 0,
        ...
        $async$returnValue;
      var $async$delayedIdentity$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait(A.Future_Future$delayed(A.Duration$(100), type$.dynamic), $async$delayedIdentity$1);
            case 3:
              // returning from await.
              $async$returnValue = n;
              // goto return
      ...
      return A._asyncStartSync($async$delayedIdentity$1, $async$completer);
    },
    delayedSequence$2(count, token) {
      var $async$delayedSequence$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              if (t3 === true)
                throw A.wrapException(A.CancelledException$(t2 ? null : token._cancellation_token$_message));
              $async$goto = 6;
              return A._asyncStarHelper(A.Future_Future$delayed(A.Duration$(100), t1), $async$delayedSequence$2, $async$controller);
            case 6:
              // returning from await.
              $async$goto = 7;
              $async$nextWhenCanceled = [1];
              return A._asyncStarHelper(A._IterationMarker_yieldSingle(i), $async$delayedSequence$2, $async$controller);
            case 7:
              // after yield
            case 4:
              // for update
      ...
      var $async$goto = 0,
        $async$controller = A._makeAsyncStarStreamController($async$delayedSequence$2, type$.int),
    ...
    cancellableSequence$1(token) {
      var $async$cancellableSequence$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        switch ($async$errorCode) {
          case 2:
            $async$next = $async$nextWhenCanceled;
            $async$goto = $async$next.pop();
          ...
          switch ($async$goto) {
            ...
            case 3:
              ...
              if (token.get$exception() != null)
                throw A.wrapException(A.CancelledException$(token._cancellation_token$_message));
              $async$goto = 5;
              return A._asyncStarHelper(A.Future_Future$delayed(A.Duration$(100), t1), $async$cancellableSequence$1, $async$controller);
            case 5:
              // returning from await.
              $async$goto = 6;
              $async$nextWhenCanceled = [1];
              return A._asyncStarHelper(A._IterationMarker_yieldSingle(i), $async$cancellableSequence$1, $async$controller);
            case 6:
              // after yield
              ++i;
              // goto for condition
      ...
      var $async$goto = 0,
        $async$controller = A._makeAsyncStarStreamController($async$cancellableSequence$1, type$.int),
    ...
    cancellableCpu$1(token) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        t1, i;
      var $async$cancellableCpu$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              ...
              // trivial condition
              $async$goto = 4;
              return A._asyncAwait(A.Future_Future(new A.SampleService_cancellableCpu_closure(), t1), $async$cancellableCpu$1);
            case 4:
              // returning from await.
              if (token.get$exception() != null)
                throw A.wrapException(A.CancelledException$(token._cancellation_token$_message));
      ...
      return A._asyncStartSync($async$cancellableCpu$1, $async$completer);
    },
    get$operations() {
      var result, _this = this,
        value = _this.__SampleService_operations;
      if (value === $) {
        result = A.LinkedHashMap_LinkedHashMap$_literal([1, new A.SampleService_operations_closure(_this), 2, new A.SampleService_operations_closure0(_this), 3, new A.SampleService_operations_closure1(_this), 4, new A.SampleService_operations_closure2(_this), 5, new A.SampleService_operations_closure3(_this), 6, new A.SampleService_operations_closure4(_this)], type$.int, type$.dynamic_Function_WorkerRequest);
        A._lateInitializeOnceCheck(_this.__SampleService_operations, "operations");
        _this.set$__SampleService_operations(result);
        value = result;
      }
      return value;
    },
    set$__SampleService_operations(__SampleService_operations) {
      this.__SampleService_operations = type$.Map_of_int_and_dynamic_Function_WorkerRequest._as(__SampleService_operations);
    }
  };
  A.SampleService_cancellableCpu_closure.prototype = {
    call$0() {
    },
    $signature: 1
  };
  A.SampleService_operations_closure.prototype = {
    call$1(r) {
      return A.Future_Future$delayed(A.Duration$(A._asInt(J.$index$ax(type$.WorkerRequest._as(r).args, 0))), type$.dynamic);
    },
    $signature: 9
  };
  A.SampleService_operations_closure0.prototype = {
    call$1(r) {
      return this.$this.cpu$1$milliseconds(A._asInt(J.$index$ax(type$.WorkerRequest._as(r).args, 0)));
    },
    $signature: 29
  };
  A.SampleService_operations_closure1.prototype = {
    call$1(r) {
      return this.$this.delayedIdentity$1(A._asInt(J.$index$ax(type$.WorkerRequest._as(r).args, 0)));
    },
    $signature: 30
  };
  A.SampleService_operations_closure2.prototype = {
    call$1(r) {
      type$.WorkerRequest._as(r);
      return this.$this.delayedSequence$2(A._asInt(J.$index$ax(r.args, 0)), r._cancelToken);
    },
    $signature: 10
  };
  A.SampleService_operations_closure3.prototype = {
    call$1(r) {
  ...
  A.SampleService_operations_closure4.prototype = {
    call$1(r) {
      var t1 = type$.WorkerRequest._as(r)._cancelToken;
      t1.toString;
  ...
  (function installTearOffs() {
    ...
    _static_0(A, "_js_helper_Primitives_dateNow$closure", "Primitives_dateNow", 6);
    ...
    _static_1(A, "channel___isObject$closure", "_isObject0", 32);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.ConstantStringMap_values_closure, A.Closure2Args, A.TearOffClosure, A.JsLinkedHashMap_values_closure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._asyncStarHelper_closure0, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.buildConnector_closure, A.buildMessageProcessor_closure, A.bootstrap_closure0, A.bootstrap_closure1, A.SampleService_operations_closure, A.SampleService_operations_closure0, A.SampleService_operations_closure1, A.SampleService_operations_closure2, A.SampleService_operations_closure3, A.SampleService_operations_closure4, A.main_closure]);
    _inheritMany(A.Closure0Args, [A.nullFuture_closure, A.Primitives_initTicker_closure, A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._asyncStarHelper_closure, A._AsyncStarStreamController__resumeBody, A._AsyncStarStreamController__resumeBody_closure, A._AsyncStarStreamController_closure, A._AsyncStarStreamController_closure0, A._AsyncStarStreamController_closure1, A._AsyncStarStreamController__closure, A.Future_Future_closure, A.Future_Future$delayed_closure, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainForeignFuture_closure1, A._Future__asyncCompleteWithValue_closure, A._Future__chainFuture_closure, A._Future__asyncCompleteError_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_length_closure0, A._StreamController__subscribe_closure, A._StreamController__recordCancel_complete, A._AddStreamState_cancel_closure, A._BufferingStreamSubscription__sendError_sendError, A._BufferingStreamSubscription__sendDone_sendDone, A._PendingEvents_schedule_closure, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure, A._WorkerMonitor__getTokenRef_closure, A.bootstrap_closure, A.SampleService_cancellableCpu_closure]);
