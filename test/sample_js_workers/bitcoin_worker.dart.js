...
(function dartProgram() {
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(@)", "~(~())", "bool(_Highlight)", "String(Match)", "Null()", "@()", "~(Object,StackTrace)", "~(Object?)", "bool(@)", "int(@,@)", "~(MessageEvent)", "bool(Object?,Object?)", "bool(String)", "String(String)", "Null(@)", "int(Object?)", "Null(ProgressEvent)", "~(Event)", "~(String,String)", "~(Uint8List,String,int)", "~(String,int?)", "int(int,int)", "Uint8List(@,@)", "~(String,int)", "Future<Null>()", "@(Object?)", "~(@,@)", "Null(@,StackTrace)", "@(@,@)", "Future<String>(Client)", "bool(String,String)", "int(String)", "~(Object?,Object?)", "~(List<int>)", "_Future<@>(@)", "MediaType()", "0^(0^,0^)<num>", "Null(Object,StackTrace)", "String(String?)", "String?()", "int(_Line)", "@(String)", "Object(_Line)", "Object(_Highlight)", "int(_Highlight,_Highlight)", "List<_Line>(MapEntry<Object,List<_Highlight>>)", "SourceSpanWithContext()", "_CancellationTokenReference()", "~(Object[StackTrace?])", "Future<double?>(WorkerRequest)", "BitcoinService(WorkerRequest)", "~(int,@)", "@(@,String)", "@(@)", "Null(~())", "Null(@,@)"],
