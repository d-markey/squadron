...
(function dartProgram() {
  ...
  var A = {
    main() {
      X.bootstrap(new A.main_closure(), C.Map_empty);
    },
  ...
  var holders = [A, C, H, J, M, N, P, Q, R, U, W, X];
  ...
  (function installTearOffs() {
    ...
    _static_1(N, "channel___isObject$closure", "_isObject0", 25);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(@)", "bool(Object)", "~(~())", "Null(@)", "Null()", "@(WorkerRequest)", "Future<Null>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?)", "~(Object?,Object?)", "~(Event)", "~(@,@)", "Null(@,@)", "@(@,@)", "~(MessageEvent)", "Future<~>(MessageEvent)", "RogueService(WorkerRequest)", "bool(@)"],
