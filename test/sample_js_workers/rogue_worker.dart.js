...
(function dartProgram() {
  ...
  X = {
    ...
    WorkerRequest$deserialize(message) {
      ...
      t4 = t1 ? _null : message.$index(0, "d");
      t4 = H._asBool(t4 == null ? false : t4);
      t1 = t1 ? _null : message.$index(0, "e");
      return new X.WorkerRequest(t2, t3, t4, H._asBool(t1 == null ? false : t1));
    },
  ...
  var holders = [A, C, H, J, K, M, N, P, Q, R, U, W, X];
  ...
  U.RogueService.prototype = {
    throwWorkerException$0() {
      return H.throwExpression(M.WorkerException$("intended worker exception"));
    },
    throwException$0() {
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(@)", "~(~())", "Null(@)", "Null()", "~(MessageEvent)", "@(WorkerRequest)", "Future<Null>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?)", "~(Object?,Object?)", "~(Event)", "~(@,@)", "Null(@,@)", "@(@,@)", "RogueService(WorkerRequest)", "bool(@)"],
