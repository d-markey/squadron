...
(function dartProgram() {
  ...
  var A = {
    main() {
      var t4,
        ...
        t3 = t2._as(new A.main_closure(scope, operations));
      type$.nullable_void_Function._as(null);
      t4 = type$.MessageEvent;
      W._EventStreamSubscription$(t1, "message", t3, false, t4);
      W._EventStreamSubscription$(scope, "message", t2._as(new A.main_closure0(com, operations)), false, t4);
    },
  ...
  var holders = [A, C, H, J, M, N, P, R, U, W, X, Y];
  ...
  U.RogueService.prototype = {
    throwWorkerException$0() {
      return H.throwExpression(M.WorkerException$("intended worker exception", null));
    },
    throwException$0() {
  ...
  A.main_closure0.prototype = {
    call$1(e) {
      Y.Worker_connect(X.WorkerRequest$deserialize(type$.Map_dynamic_dynamic._as(new P._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(type$.MessageEvent._as(e).data, true))).client, this.com.port2, this.operations, new U.RogueService().get$operations());
    },
    $signature: 7
  };
  (function aliases() {
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(@)", "bool(Object)", "~(~())", "Null(@)", "Null()", "@(WorkerRequest)", "~(MessageEvent)", "Future<Null>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?)", "~(Object?,Object?)", "~(Event)", "~(@,@)", "Null(@,@)", "@(@,@)", "bool(@)"],
