...
(function dartProgram() {
  ...
  var A = {
    main() {
      return X.bootstrap(new A.main_closure(), null);
    },
  ...
  U = {RogueService: function RogueService() {
      this.__RogueService_operations = null;
  ...
  var holders = [A, C, H, J, K, M, N, P, Q, R, U, W, X, Y];
  ...
  U.RogueService.prototype = {
    throwWorkerException$0() {
      return H.throwExpression(M.WorkerException$("intended worker exception", null, null));
    },
    throwException$0() {
      return H.throwExpression(P.Exception_Exception("intended exception"));
    },
    get$operations() {
      var _this = this,
        t1 = _this.__RogueService_operations;
      if (t1 == null) {
        t1 = P.LinkedHashMap_LinkedHashMap$_literal([1, new U.RogueService_operations_closure(_this), 2, new U.RogueService_operations_closure0(_this)], type$.int, type$.dynamic_Function_WorkerRequest);
        if (_this.__RogueService_operations == null)
          _this.set$__RogueService_operations(t1);
        else
    ...
    set$__RogueService_operations(__RogueService_operations) {
      this.__RogueService_operations = type$.nullable_Map_of_int_and_dynamic_Function_WorkerRequest._as(__RogueService_operations);
    }
  };
  U.RogueService_operations_closure.prototype = {
    call$1(r) {
  ...
  U.RogueService_operations_closure0.prototype = {
    call$1(r) {
      type$.WorkerRequest._as(r);
  ...
  (function installTearOffs() {
    ...
    _static_1(N, "channel___isObject$closure", "_isObject0", 24);
  })();
  (function inheritance() {
    ...
    _inheritMany(H.Closure, [H.Closure0Args, H.ConstantStringMap_values_closure, H.Closure2Args, H.TearOffClosure, H.JsLinkedHashMap_values_closure, H.initHooks_closure, H.initHooks_closure1, P._AsyncRun__initializeScheduleImmediate_internalCallback, P._AsyncRun__initializeScheduleImmediate_closure, P._awaitOnObject_closure, P._Future__chainForeignFuture_closure, P._Future__propagateToListeners_handleWhenCompleteCallback_closure, P.Stream_length_closure, P._RootZone_bindUnaryCallbackGuarded_closure, W._EventStreamSubscription_closure, P.promiseToFuture_closure, P.promiseToFuture_closure0, X.bootstrap_closure, X.bootstrap_closure1, U.RogueService_operations_closure, U.RogueService_operations_closure0, A.main_closure]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(@)", "~(~())", "Null(@)", "Null()", "~(MessageEvent)", "@(WorkerRequest)", "Future<Null>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?)", "~(Object?,Object?)", "~(Event)", "~(@,@)", "Null(@,@)", "@(@,@)", "CancellationTokenReference()", "RogueService(WorkerRequest)", "bool(@)"],
