...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    Future_wait(futures, $T) {
      var error, stackTrace, handleError, future, pos, e, st, t2, _i, t3, exception, _box_0 = {}, cleanUp = null,
        eagerError = false,
    ...
    bootstrap(initializer, command) {
      ...
      t5 = self;
      t5.toString;
      A._EventStreamSubscription$(type$.DedicatedWorkerGlobalScope._as(t5), "message", t3._as(new A.bootstrap_closure0(runner, t1, initializer)), false, t4);
    },
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              if (!t1)
                A.WorkerRequestExt_unwrapRequestInPlace(startRequest, $async$self.internalLogger);
      ...
      var $async$processMessage$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              A.WorkerRequestExt_unwrapRequestInPlace(request, $async$self.internalLogger);
