...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _post(logger, message, post) {
      ...
      try {
        ...
        st = A.getTraceFromException(exception);
        logger.e$1(0, new A._post_closure(message, ex));
    ...
    _BaseJsChannel__inspectAndPostResponse_closure: function _BaseJsChannel__inspectAndPostResponse_closure(t0, t1, t2) {
      this.$this = t0;
      this.res = t1;
      this.transfer = t2;
    },
  ...
  A.bootstrap_closure.prototype = {
    call$1(r) {
      var t1;
      r.internalLogger.t$1("terminating Web Worker");
      t1 = this.com;
      t1.port1.close();
      t1.port2.close();
      t1 = self;
  ...
  A._BaseJsChannel.prototype = {
    _postResponse$1(res) {
      ...
      A._post(this.__channel$_logger, res, new A._BaseJsChannel__postResponse_closure(this, res));
    },
    _inspectAndPostResponse$1(res) {
      var t1, objects, transfer;
      A.WorkerResponseExt_wrapInPlace(res);
      ...
      A._post(this.__channel$_logger, res, new A._BaseJsChannel__inspectAndPostResponse_closure(this, res, transfer));
    }
  };
  A._BaseJsChannel__postResponse_closure.prototype = {
    call$0() {
      return B.MessagePort_methods.postMessage$1(this.$this._sendPort, this.res);
    },
    $signature: 0
  };
  A._BaseJsChannel__inspectAndPostResponse_closure.prototype = {
    call$0() {
      return B.MessagePort_methods.postMessage$2(this.$this._sendPort, this.res, this.transfer);
    },
    $signature: 0
  };
  ...
  A.WorkerRunner.prototype = {
    ...
    connect$body$WorkerRunner(startRequest, channelInfo, initializer) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$currentError, $async$self = this, client, $init, service, t1, ex, st, t3, service0, exception, t2, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              client = t2 ? null : type$.nullable_WorkerChannel._as(J.$index$ax(startRequest, 1));
              ...
              if (t2)
                throw A.wrapException(A.SquadronError$_("connection request expected", null));
              else if (client == null)
              ...
              $init = A.UserCode_run($async$self.internalLogger, new A.WorkerRunner_connect_closure0(initializer, startRequest), "service instantiation", type$.FutureOr_WorkerService);
            ...
            case 7:
              ...
              A.print("Sending connection request for " + A.createRuntimeType(A._instanceTypeFromConstructor(B.MessagePort_methods)).toString$0(0) + " / " + ("0x" + B.JSString_methods.padLeft$2(B.JSInt_methods.toRadixString$1(A.Primitives_objectHashCode(channelInfo), 16), 8, "0")));
  ...
  A.SquadronCanceledExceptions.prototype = {
    ...
    toString$0(_) {
      return A.getRuntimeTypeOfDartObject(this).toString$0(0) + ": " + B.C_JsonCodec.encode$2$toEncodable(this.serialize$0(), null);
    },
    serialize$0() {
      var t1 = this._exceptions,
        t2 = A._arrayInstanceType(t1);
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "_user_code_UserCode__noop$closure", "UserCode__noop", 2);
    _static_1(A, "squadron_canceled_exception__SquadronCanceledExceptionExt_deserialize$closure", "SquadronCanceledExceptionExt_deserialize", 50);
    _static_1(A, "_transferables_Transferables__isBaseType$closure", "Transferables__isBaseType", 11);
    _static_1(A, "_transferables_Transferables__isSafeForTransfer$closure", "Transferables__isSafeForTransfer", 11);
    _static_1(A, "_transferables_Transferables__isNotSafeForTransfer$closure", "Transferables__isNotSafeForTransfer", 11);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(String,@)", "~(@)", "@(List<@>)", "Stream<int>(List<@>)", "Null()", "~(Object,StackTrace)", "~(~())", "Null(@)", "Future<int>(List<@>)", "~(List<@>)", "bool(Object?)", "~(Object?,Object?)", "int()", "@(@)", "Future<@>(List<@>)", "Null(Object,StackTrace)", "Null(List<@>)", "~(Object?)", "String()", "~(MessageEvent)", "~(@,@)", "~(String,String)", "~(Event)", "@(@,String)", "~(@,StackTrace)", "@(@,@)", "~(WorkerRunner)", "int(int)", "int(int,int)", "~(OutputEvent)", "WorkerService/()", "bool(int)", "Future<Null>()", "SquadronCanceledException(CanceledException)", "String(SquadronCanceledException)", "List<@>(SquadronCanceledException)", "bool(Level)", "bool(CanceledException)", "_Future<@>(@)", "_Future<@>?()", "~(int,@)", "Null(@,StackTrace)", "CancelationTokenReference()", "bool/(List<@>)", "Null(~())", "int/(List<@>)", "Future<Object>(List<@>)", "TestService(List<@>)", "@(String)", "SquadronCanceledException?(List<@>?)", "Null(@,@)"],
