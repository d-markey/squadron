...
(function dartProgram() {
  ...
  (function installTearOffs() {
    ...
    _instance_2_u(_, "get$_handleError", "_handleError$2", 50);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(@)", "@(List<@>)", "Null()", "Stream<int>(List<@>)", "~(Object,StackTrace)", "Future<int>(List<@>)", "~(List<@>)", "Null(@)", "bool(Object?)", "~(~())", "~(Object?,Object?)", "String()", "int()", "Null(Object,StackTrace)", "~(Object?)", "@(@)", "Object?(Object?)", "bool()", "Null(List<@>)", "Future<@>(List<@>)", "Null(@,StackTrace)", "~(WorkerRunner)", "Null(JSObject)", "~(LogEvent)", "~(Object[StackTrace?,int?])", "~(int,@)", "~(JSObject)", "~(OutputEvent)", "bool(int)", "~(Object[StackTrace?])", "CancelationTokenReference()", "Future<~>()", "Future<Null>()", "Null(~())", "SquadronCanceledException(CanceledException)", "String(SquadronCanceledException)", "List<@>(SquadronCanceledException)", "_Future<@>?()", "bool(CanceledException)", "_Future<@>(@)", "@(String)", "int(int)", "@(@,String)", "Null(@,@)", "bool/(List<@>)", "bool(Level)", "int/(List<@>)", "Future<Object>(List<@>)", "TestService(List<@>)", "~(@,StackTrace)", "SquadronCanceledException?(List<@>?)", "int(int,int)"],
