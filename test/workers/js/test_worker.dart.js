...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    bootstrap(initializer, command) {
      ...
      t2._as(t1.self).postMessage(A.jsify(A.WorkerResponseExt_wrapInPlace([A.microsecTimeStamp(null), true, null, null, null])));
    },
    ...
    NumConverter__numCastors_closure: function NumConverter__numCastors_closure() {
    },
    NumConverter__numCastors_closure0: function NumConverter__numCastors_closure0() {
    },
  ...
  A._WebWorkerChannel.prototype = {
    _postResponse$1(res) {
      ...
      try {
        ...
        msg = A.jsify(data);
        this._sendPort.postMessage(msg);
      } catch (exception) {
        ex = A.unwrapException(exception);
        st = A.getTraceFromException(exception);
    ...
    _inspectAndPostResponse$1(res) {
      var data, msg, transfer, jsTransfer, ex, st, t1, objects, t2, exception;
      try {
        data = A.WorkerResponseExt_wrapInPlace(res);
        msg = A.jsify(data);
  ...
  A.CastConverter.prototype = {
    v$1$0($T) {
      return A.instantiate1(A.cast_converter_CastConverter_identity$closure(), $T);
    }
  };
  A.NumConverter.prototype = {
    v$1$0($T) {
      var t1 = $T._eval$1("0(@)?")._as($.$get$NumConverter__numCastors().$index(0, A.createRuntimeType($T)));
      return t1 == null ? this.super$CastConverter$v($T) : t1;
    }
  };
  A.NumConverter__numCastors_closure.prototype = {
    call$1(x) {
      return B.JSNumber_methods.toInt$0(A._asNum(x));
    },
    $signature: 35
  };
  A.NumConverter__numCastors_closure0.prototype = {
    call$1(x) {
      return A._asNum(x);
    },
    $signature: 46
  ...
  A.TestService_operations_closure3.prototype = {
    call$1(r) {
      var t1 = type$.List_dynamic;
      return A.Future_Future$delayed(A.Duration$(0, B.JSNumber_methods.toInt$0(A._asNum(J.$index$ax(t1._as(J.$index$ax(t1._as(r), 3)), 0)))), type$.void);
    },
    $signature: 13
  };
  ...
  A.main_closure.prototype = {
    call$1(startReq) {
      var t1 = J.getInterceptor$ax(startReq),
        t2 = type$.List_dynamic,
        t3 = $.platformConverter.v$1$0(type$.bool).call$1(J.$index$ax(t2._as(t1.$index(startReq, 3)), 0)) ? B.C_NumConverter : B.C_CastConverter;
      $.platformConverter = t3;
      switch (t3.v$1$0(type$.int).call$1(J.$index$ax(t2._as(t1.$index(startReq, 3)), 1))) {
        case 1:
  ...
  (function aliases() {
    ...
    _.super$CastConverter$v = _.v$1$0;
  })();
  (function installTearOffs() {
    ...
    _static(A, "cast_converter_CastConverter_identity$closure", 1, null, ["call$1$1", "call$1"], ["CastConverter_identity", function(x) {
      return A.CastConverter_identity(x, type$.dynamic);
    }], 53, 0);
    _static_1(A, "squadron_canceled_exception__SquadronCanceledExceptionExt_deserialize$closure", "SquadronCanceledExceptionExt_deserialize", 54);
...
;
  ...
  (function staticFields() {
    ...
    $.platformConverter = B.C_CastConverter;
  })();
  (function lazyInitializers() {
    ...
    _lazyFinal($, "NumConverter__numCastors", "$get$NumConverter__numCastors", () => A.LinkedHashMap_LinkedHashMap$_literal([B.Type_int_8nG, new A.NumConverter__numCastors_closure(), B.Type_double_23F, new A.NumConverter__numCastors_closure0()], A.findType("Type"), A.findType("@(@)")));
