@echo off
rem do not minify compiled JavaScript because some tests inspect the stacktrace for specific names
...
CALL dart.bat compile js -o "%~dp0sample_js_workers\sample_worker.dart.js"     "%~dp0sample_js_workers\sample_worker.dart"
