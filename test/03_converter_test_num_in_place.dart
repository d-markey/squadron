...
void testInPlaceNumConverter(TestContext tc) {
  tc.group('- InPlaceConverter + NumConverter', () {
    final converter = InPlaceConverter(NumConverter.instance);
